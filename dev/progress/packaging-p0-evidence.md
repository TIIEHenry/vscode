...
- `npm run gulp vscode-linux-x64`（§4.3）— 无窗子集已拆到 [D388](../roadmap/active/d388-packaging-p1-asar-machine.md)（**已闭**）；父方案 [packaging-and-release](../plans/packaging-and-release.md) 仍 `accepted`。活窗 / D18 另计
