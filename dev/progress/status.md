...
phase: M7
updated: 2026-09-17
summary: "工位 G D604：layout openView 七处双链。mocha 2/0。D24 仍开。不是 leftover/pills 完成。勿 add out。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **G** | [D604](deferred-gaps.md) layout `openView`/`openViewContainer`/`_openDefaultAuxiliaryBarContainer` 七处双链；mocha **2/0**；未 commit；勿 add `out` |
...
| [D604](deferred-gaps.md) | **closed** 本文件七处双链；leftover **未**全局完成 |
