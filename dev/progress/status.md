...
| **D** | `loop/D-d24-detail-panel-leftover` — detailPanel `_syncTarget` 双链；[D642](deferred-gaps.md)；D24 仍开；leftover 未全局完成；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D642](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
