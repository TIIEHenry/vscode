...
phase: M7
updated: 2026-09-12
summary: "合入 D311 Triggers leftover 写闸 + D312 Sources leftover 写闸。D8/D16/D147 仍开。"
---
...
### 已合入（`MERGE_SHA=8c23b63214d` compile-client 0；push 后以 `origin/agent-ide` 为准）
| 切片 | 提交 / 落点 |
|:-----|:------------|
...
### 关仓（2026-09-12 · A D311 + B D312；前波 D309–D310 已在库）
| 槽 | 切片 | 关仓状态 |
|:---|:-----|:---------|
| **A** | `triggers-leftover-looks-live-writes` [D311](deferred-gaps.md) | `already-committed` `1bab8c338cf`；Triggers leftover 写闸 |
| **B** | `sources-leftover-looks-live-writes` [D312](deferred-gaps.md) | `already-committed` `9a0009d3d42`；Sources Stage/Commit leftover 写闸 |
...
|----|------|------|-----|:--|:------|:---------|
| merge | `vscode-WorkTrees/merge` | `loop/merge` | `8c23b63214d` | 干净 | 0 | `parked`；compile-client 0；本账 +1 以远程 tip 为准 |
| A | `vscode-WorkTrees/A` | `loop/A` | `1bab8c338cf` | 干净 | 0 | merge-queued D311 `triggers-leftover-looks-live-writes` |
| B | `vscode-WorkTrees/B` | `loop/B` | `9a0009d3d42` | 干净 | 0 | merge-queued D312 `sources-leftover-looks-live-writes` |
| C | `vscode-WorkTrees/C` | `loop/C` | `8c23b63214d` | 未提交 `dev/loop` | 0 | idle；勿 add `dev/loop` |
| D | `vscode-WorkTrees/D` | `loop/D` | `8c23b63214d` | 干净 | 0 | idle；跟 MERGE_SHA |
...
| **loop 切片** | 关仓合入 D311 Triggers + D312 Sources leftover 写闸。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto |
