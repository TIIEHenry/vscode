...
| **I** | `loop/I-d24-feedback-reveal-leftover` — widget `revealFeedback` 双链；[D638](deferred-gaps.md)；D24 仍开；leftover 未全局完成；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D631](deferred-gaps.md)/[D638](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
