...
### 进行中（2026-09-13 · P2 合入 A D425 / B D424）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
...
| [D405](deferred-gaps.md)–[D426](deferred-gaps.md) | A/B/D 本波 | D405 手测仍开；D413–D422/D424/D425 closed；D423 仍 occupied；D426 MCP UNKNOWN leftover toggle 仍开；不得宣称 leftover wave 完成 |
...
| **loop 切片** | 合入 A **D425**（111/0）/ B **D424**（20/0）。D **D423** 仍 occupied。**D405** 手测仍开。**D426** 仍开。不关 D8/D16/D147。下号 **D427**。未升 PRD-008。 |
