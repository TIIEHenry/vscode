...
phase: M7
updated: 2026-09-12
summary: "已收 D382+D383（未提交）。D379–D381 已关仓。D8/D16/D147 仍开。"
---
...
### 关仓（2026-09-12 · A D379 / B D381 / D D380 compile-client 0；A 已收 D383 未提交）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | `composer-permission-model-post-await leftover-looks-live` [D383](deferred-gaps.md) | 已收（未提交）；in-flight leftover restore，非 live Permission/Model |
| **B** | `plugins-scanNew leftover-looks-live` [D381](deferred-gaps.md) | 已关仓 `56cbd76f7d3`；不画 live scan |
| **D** | `host-tree-refresh` [D380](deferred-gaps.md)；`host-resync-ack` [D382](deferred-gaps.md) | D380 已关仓 `07d035334aa`；**已收 D382（未提交）** |
...
| A | `vscode-WorkTrees/A` | `loop/A` | 跟 MERGE_SHA | D383 未提交 | 0 | 已收 D383（未提交） |
...
| D | `vscode-WorkTrees/D` | `loop/D` | 跟 MERGE_SHA | 脏 | 0 | 已关仓 D380；**已收 D382（未提交）** |
...
| **loop 切片** | 已收 [D382](deferred-gaps.md)+[D383](deferred-gaps.md)（未提交）。[D379](deferred-gaps.md)–[D381](deferred-gaps.md) 已关仓。下一未占用 ID **D384**。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto；未宣称 leftover-honesty 程序完成 |
