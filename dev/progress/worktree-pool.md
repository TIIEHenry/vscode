...
created: 2026-08-30
updated: 2026-09-14
summary: "仓外 vscode-WorkTrees；基线 agent-ide；MERGE_SHA a653fc086aa 已 push"
---
...
| 集成本次 HEAD | `a653fc086aa`（`loop/merge` · 2026-09-14 关仓；已 push `origin/agent-ide`） |
| 工位池 compile | compile-client 0 @ `a653fc086aa` |

## 槽位表（2026-09-14 · `MERGE_SHA`=`a653fc086aa`）

| 槽 | 路径 | 分支 | tip | 状态 |
|:---|:-----|:-----|:-----|:-----|
| merge | `vscode-WorkTrees/merge` | `loop/merge` | `a653fc086aa` | `parked`；== `origin/agent-ide` |
| A | `vscode-WorkTrees/A` | `loop/A` | `a653fc086aa` | `idle` |
...
| D | `vscode-WorkTrees/D` | `loop/D` | `a653fc086aa` | `idle` |
