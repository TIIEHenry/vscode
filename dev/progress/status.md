...
phase: M7
updated: 2026-09-16
summary: "工位 D leftover：D570 关 agentHostSessionListStore workspace-folders refresh 双链（仅本 call site）。compile-client 0。D24 仍开。不是 leftover/pills 完成。"
---
...
| **D** | leftover `agentHostSessionListStore` workspace-folders `refresh` 双链；[D570](deferred-gaps.md) 本 call site closed；未 commit |
...
| [D570](deferred-gaps.md) | **closed** 本 call site only；leftover **未**全局完成 |
