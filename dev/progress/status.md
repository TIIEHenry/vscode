...
### 进行中（2026-09-11 · D293 本槽已闭）
| 槽 | 切片 | 状态 |
|:---|:-----|:-----|
| **A** | roster-pairing-pending-count | 已进 merge；[D291](deferred-gaps.md) 已闭 |
| **B** | roster-pairing-live-sync-demote | 本槽已闭；[D293](deferred-gaps.md) 已闭 |
...
| **loop 切片** | [D293](deferred-gaps.md) 本槽已闭（未进 merge）。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto |
