...
phase: M7
updated: 2026-09-17
summary: "工位 G：D588 关 pluginList 列表 renderer Install 一处。compile-client 0。D24 仍开。不是 leftover/pills 完成。"
---
...
| **G leftover** | list-renderer Install ~469 双链；[D588](deferred-gaps.md)；未 commit；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D583](deferred-gaps.md) | **closed** leftover catch（前波） |
| [D588](deferred-gaps.md) | **closed** 列表 renderer Install 一处；leftover **未**全局完成 |
