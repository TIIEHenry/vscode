...
phase: M7
updated: 2026-09-17
summary: "A leftover D616：chatCompositeBar renameChat 双链。mocha 3/0。未 commit。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **A** | leftover `loop/A-d24-chatbar-rename-leftover`；[D616](deferred-gaps.md) mocha **3/0**；未 commit；勿 compile-client；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D616](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
