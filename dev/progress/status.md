...
phase: M7
updated: 2026-09-16
summary: "C Pause wire 已落，grpcClient 仍 JSON，D24 仍开。关仓五条 Agent wire 未接线。compile-client 0。不是 leftover/pills 完成。"
---
...
| **C** | Pause wire 已落；grpcClient 仍 JSON；[D24](deferred-gaps.md) 仍开 |
...
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：Clear/Get·SetModelPreferences **已** bytes；SwitchWorkDir/Compact/Todo/Usage/Status/Pause wire 未接线；ResolveTurn/Connect/SaveSkillContent/Watch·Rebuild 仍 JSON |
...
| 项 | 指针 |
|:---|:-----|
| **loop** | D24 仍开。Pause wire 已落、grpcClient 仍 JSON。A 下一刀接 SwitchWorkDir/Compact/Todo/Usage/Status/Pause。SaveSkillContent 无 RPC。Connect/Watch 跳过。不得宣称 leftover/pills 完成 |
