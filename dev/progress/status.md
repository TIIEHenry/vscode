...
phase: M7
updated: 2026-09-17
summary: "G leftover：pluginListWidget refresh() await filterPlugins。[D612](deferred-gaps.md)。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **G** | `loop/G-d24-plugin-refresh-filter-leftover` [D612](deferred-gaps.md) `refresh()` await filterPlugins；未 commit；勿 add `out` |
...
| [D612](deferred-gaps.md) | **closed** pluginListWidget `refresh()` await filterPlugins；leftover **未**全局完成 |
