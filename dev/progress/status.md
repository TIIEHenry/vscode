...
phase: M7
updated: 2026-09-17
summary: "C D593：plugin 详情 install/uninstall/copy/open 四 click 双链。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **C** | [D593](deferred-gaps.md) 详情 install/uninstall/copy/open 四 click 双链；D24 仍开 |
...
| [D550](deferred-gaps.md)–[D593](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
