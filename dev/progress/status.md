...
phase: M7
updated: 2026-09-16
summary: "merge compile-client 0；聚焦测 92 passing。D481 closed；D24 仍开（Memory grpcClient JSON）。F Memory unary wire 未接线。不是 leftover/pills 完成。R9/D405/D487 仍开"
---
...
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A/D** | D24 Tool leftover unaries bytes + D481 | A：SkillInfo/SetSkillEnabled/ToolInfo/ListCommands/GetCommandDef（+DeleteAgentProfile）转 bytes。未转 SaveSkillContent。[D24](deferred-gaps.md) **仍开**（Memory grpcClient / ChatSync JSON）。[D481](deferred-gaps.md) **closed**。不是 leftover/pills 完成 |
...
| [D24](deferred-gaps.md) | A bytes；F Memory wire | **仍开**：question/client-tool 已 bytes；Memory unary wire 未接线 grpcClient；ChatSync 仍 JSON |
...
| [D405](deferred-gaps.md)–[D481](deferred-gaps.md) | A/D 本波 | D405 手测仍开；D471–D481 已闭；**D24 仍开**（Tool leftover unaries 已 bytes；Memory grpcClient / ChatSync 仍 JSON；F unary wire 未接线）；[D487](deferred-gaps.md) score double **open**；不得宣称 leftover/pills 完成 |
...
| F | `vscode-WorkTrees/F` | `loop/F` | `731cf18f61a` | 本切片 | 0 | Memory unary wire 未接线 grpcClient；D24 仍开 |
...
| **loop 切片** | A Tool leftover unaries 已 bytes（SkillInfo/SetSkillEnabled/ToolInfo/ListCommands/GetCommandDef；+DeleteAgentProfile）。未转 SaveSkillContent。F Memory unary wire 未接线 grpcClient。[D24](deferred-gaps.md) **仍开**（Memory grpcClient / ChatSync JSON）。[D481](deferred-gaps.md) **closed**。[D487](deferred-gaps.md) score double 未读。R9 / **D405** 仍开。不关 D8/D16/D147。未升 PRD-008。不得宣称 leftover / pills 完成。 |
