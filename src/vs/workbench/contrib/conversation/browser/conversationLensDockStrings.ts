...
export const conversationLensDockNoEngineTools = localize('conversationLens.dockNoEngineTools', "No tools from engine");
export const conversationLensDockToolsEngineHint = localize('conversationLens.dockToolsEngineHint', "Enablement is on the Engine page. This list does not change the session.");
...
export const conversationLensDockPermissionAgent = localize('conversationLens.dockPermissionAgent', "Agent");
...
export const conversationLensDockRouteBalanced = localize('conversationLens.dockRouteBalanced', "Stub Balanced");
export const conversationLensDockRouteSpeed = localize('conversationLens.dockRouteSpeed', "Stub Speed");
export const conversationLensDockRouteQuality = localize('conversationLens.dockRouteQuality', "Stub Quality");
