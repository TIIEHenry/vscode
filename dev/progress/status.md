...
phase: M7
updated: 2026-09-17
summary: "D 槽：newChatInput 两处 OTEL executeCommand 双链（D594）。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **D** | newChatInput 两处 OTEL executeCommand 双链；[D594](deferred-gaps.md)；D24 仍开；不是 leftover/pills 完成 |
...
| [D550](deferred-gaps.md)–[D594](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
