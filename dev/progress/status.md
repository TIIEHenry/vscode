...
phase: M7
updated: 2026-09-16
summary: "merge compile-client 0；聚焦 8 文件 327 passing。A SetPermissionPolicy+Doctor 已 bytes；D508–D514 closed。工位 J D521 单链升双链（未 compile-client）。D24 仍开。不是 leftover/pills 完成。"
---
...
| **D/F/G/H/I** | D509–D513 | 已合入 merge |
| **J** | D521 | 本工位：Agents reveal/executeCommand 单链升双链；openView 不重做；未 compile-client；leftover **未**全局完成 |
...
| [D521](deferred-gaps.md) | J | **closed** Agents 三处残留单链升双链；leftover **未**全局完成 |
...
| 项 | 指针 |
|:---|:-----|
| **loop 切片** | [D24](deferred-gaps.md) **仍开**（SaveSkillContent/Rebuild/Watch/GetModelPreferences/SetModelPreferences/ResolveModel 仍 JSON）。[D508](deferred-gaps.md)–[D514](deferred-gaps.md) **closed**。[D521](deferred-gaps.md) **closed**（工位 J，未合入）。[D487](deferred-gaps.md) **open**。不得宣称 leftover / pills 完成 |
