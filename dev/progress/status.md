...
phase: M7
updated: 2026-09-02
summary: "loop/merge 已合入 M7 代码与 accepted 方案；P/A/B/C 主线切片已落（含 CS-1–CS-6）；PRD-026 仍 accepted；D17–D20 / W1 旁路"
---
...
- **未完：** W1 Web 冒烟不挡主线；I6 发行标识等发布方；THEME/Connection 见 [D19](deferred-gaps.md)；Settings 300px 目视见 [D20](deferred-gaps.md)。
