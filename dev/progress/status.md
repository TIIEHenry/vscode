...
phase: M7
updated: 2026-09-04
summary: "D16 identity 改走共享 ResizeObserver / layout flush harness；Rename/Cancel catalog；roster 接通后转发 Rename 与 Inbox Stop Cancel"
---
...
| D | `vscode-WorkTrees/D` | `loop/D` | D16 identity 接入共享 layout harness |
...
| V | D16 identity 已接共享 harness；剩 `conversationLens.test.ts` 本地 listener / DOM/codicon 断言债；D17 与产品验证 |
