...
phase: M7
updated: 2026-09-12
summary: "已关仓 D373–D375 compile-client 0。已收 D378（未提交）。D8/D16/D147 仍开。"
---
...
### 关仓（2026-09-12 · A D373 / B D374 / D D375 compile-client 0；D378 未提交）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | `inbox-keep-chrome leftover-looks-live` [D373](deferred-gaps.md) | 已关仓 `7f755ed8dc7`；leftover-looks-live 非 live queue/generating |
| **B** | `roster leftover-looks-live KEEP-chrome` [D374](deferred-gaps.md) | 已关仓 `96ac97f7f8a`；demote + 首拉不翻 wasEverConnected |
| **D** | `host-write leftover-looks-live` [D375](deferred-gaps.md) / [D378](deferred-gaps.md) | D375 已关仓 `d5eb661d286`；**已收 D378（未提交）** leftover-looks-live 不 bring-up |
...
| A | `vscode-WorkTrees/A` | `loop/A` | `7f755ed8dc7` | 干净 | 0 | 已收 D373 |
| B | `vscode-WorkTrees/B` | `loop/B` | `96ac97f7f8a` | 干净 | 0 | 已收 D374 |
| C | `vscode-WorkTrees/C` | `loop/C` | 跟 MERGE_SHA | 未提交 `dev/loop` | 0 | idle；勿 add `dev/loop` |
| D | `vscode-WorkTrees/D` | `loop/D` | `bc6ee8d10b8` | D378 未提交 | 0 | 已收 D378（未提交） |
...
| **loop 切片** | [D373](deferred-gaps.md)–[D375](deferred-gaps.md) 已关仓 compile-client 0。**已收 D378（未提交）**。下一未占用 ID **D379**。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto；未宣称 leftover-honesty 程序完成 |
