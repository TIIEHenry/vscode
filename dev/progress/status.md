...
phase: M7
updated: 2026-09-10
summary: "loop 本波：A D246 已合；B/C/D 仍在工位。未 compile-client。"
---
...
| **C** | hub-directory-leftover | 工位进行中 [D248](deferred-gaps.md)；勿 add `dev/loop` |
| **D** | composer-preclear-keep-last | 工位进行中 [D249](deferred-gaps.md) |
...
| [D242](deferred-gaps.md)–[D245](deferred-gaps.md) | A–D leftover 关仓波 | **closed** Snapshots / Plugins hooks / Changes / Review list throw leftover；merge compile-client 0 |
...
| **loop 切片** | D242–D245 已 compile-client 0；下一波从代码搜 leftover（D246+）。勿派 D147 / 勿开 F3·A2 / 勿发明 proto / 勿改引擎仓 |
