...
| D5 | P2 | **EH 探针冒烟**（LSP + layout 类扩展） | 三探针 wave3 PASS；panel/terminal/decoration 仍待 | [eh-surface-matrix](../../docs/reference/code-oss-b2/eh-surface-matrix.md) 三探针行 **已实测 @2026-09-02** | M4 | open |
