...
phase: M7
updated: 2026-09-12
summary: "已收 D366（未提交）。D8/D16/D147 仍开。"
---
...
### 关仓（2026-09-12 · A D361 / B D362 / D D363 compile-client 0）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | `sources-review-attribution leftover-looks-live` [D361](deferred-gaps.md) | 已关仓 `96f645a8bb5`；pairing-hold-first 不从 `isEngineConnected()` 单设 everConnected |
| **B** | `connection-pane-engine-pair-seat` [D362](deferred-gaps.md) | 已关仓 `17a1205bd54`；leftover-looks-live signedOut 藏 Hub devices |
| **D** | `navigator-projects-waseverconnected` [D363](deferred-gaps.md) | 已关仓 `1f5e3268827`；leftover-looks-live 事件不翻 wasEverConnected |
| **D** | History post-await leftover-looks-live [D366](deferred-gaps.md) | 已收 D366（未提交）；in-flight getHistory 再检 KEEP，不画新鲜 live |
...
| A | `vscode-WorkTrees/A` | `loop/A` | 跟 MERGE_SHA | 干净 | 0 | idle；已收 D361 |
| B | `vscode-WorkTrees/B` | `loop/B` | 跟 MERGE_SHA | 干净 | 0 | idle；已收 D362 |
| C | `vscode-WorkTrees/C` | `loop/C` | 跟 MERGE_SHA | 未提交 `dev/loop` | 0 | idle；勿 add `dev/loop` |
| D | `vscode-WorkTrees/D` | `loop/D` | 跟 MERGE_SHA | 脏 | 0 | idle；已收 D366（未提交） |
...
| **loop 切片** | 已收 D366（未提交）。D361–D365 保留。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto；未宣称 leftover-honesty 程序完成 |
