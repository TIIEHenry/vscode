...
phase: M7
updated: 2026-09-16
summary: "merge 关仓：SaveConfig/CreateRemoteSession/Status/History/UploadProgress/ResolveModel 已 bytes；leftover D553–D560 关各 call site。compile-client 0。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **A** | leftover [D560](deferred-gaps.md)：dictationOnboarding `refreshMicrophones` devicechange/~621 双链；未 commit |
...
| [D550](deferred-gaps.md)–[D560](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
