...
| **G** | D628 sandbox discover 五处双链；CatchScan 源扫；D24 仍开；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D623](deferred-gaps.md)、[D628](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
