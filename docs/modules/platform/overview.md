...
phase: N/A
updated: 2026-09-12
summary: "platform 层角色、可导入范围、DI 约定；universeAgent 会话帧走 onDynamicDidApplyFrame(leaseId) 宿主缓冲；lease 按 owner 回收；unary 默认 deadline；bind 等 whenEngineSessionReady（Create/Resume），不把 acquireLease / web-empty 当成功"
---
