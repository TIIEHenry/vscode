...
phase: M7
updated: 2026-09-08
summary: "FileMutationJoin / createScoped / Review 委托已修。D16 / D31 F4 仍开。官方三域 glob 已绿。D44–D90 / D92–D95 已闭。roster rename/delete 回滚已挂。A2 仍 blocked。"
---
...
61. **B D92–D95 / D D93**（未关 D16）：roster goal/rename/delete remote fail 回滚；split throw → notice。
子 agent 发现的既有代码问题：
| ID | 来源 | 问题 |
|:---|:-----|:-----|
...
| [D92](deferred-gaps.md)–[D95](deferred-gaps.md) | B goal/rename/delete rollback / D split notice | **closed** remote fail 回滚；split throw notice；未关 D16 |
