...
phase: M7
updated: 2026-09-17
summary: "F 进行中：D24 DownloadAttachment 流 wire+测。未接 grpcClient。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **F** | `d24-download-stream-wire`：DownloadAttachment wire+测；未接 grpcClient；[D24](deferred-gaps.md) 仍开 |
| **B** | 脏 `worktree-pool.md`；跳过；勿 `-B` |
| **E** | `blocked` `fix/ci-gate-reds` |
| **A/C/D/G/H/I/J** | parked |
| **edit** | ff-only 失败（分歧 `ff278772b85`）；勿 reset |

子 agent 发现：
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：F 已写 DownloadAttachment wire+测、未接 grpcClient。Connect/SaveSkillContent/Watch/ResolveTurn/ResolveAnchor 仍 JSON |
