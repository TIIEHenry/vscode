...
phase: M7
updated: 2026-09-16
summary: "H leftover：voiceEventStreamView 两处 void refresh 双链；D557 关 call site。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **H leftover** | `voiceEventStreamView` 两处 void refresh 双链；[D557](deferred-gaps.md) 关 call site；未 commit |
...
| [D550](deferred-gaps.md)–[D552](deferred-gaps.md)/[D557](deferred-gaps.md) | **closed** leftover catch（各 call site）；leftover **未**全局完成 |
