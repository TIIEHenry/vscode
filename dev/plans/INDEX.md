...
phase: N/A
updated: 2026-09-19
summary: "dev/plans 导航：2026-09-19 四份修补方案已签收（accepted，未实施）；conversation-timeline-session-pills（accepted）；conversation-chrome-visibility（implemented）；sources-accept-empty-success（draft；A1 已落；P5 停线）；M7 仍 accepted；GitHub Actions 已关"
---
...
| [session-subscription-lifecycle.md](session-subscription-lifecycle.md) | `draft` | lease 所有权回收、流级重开与 bind 有界化；S1–S3b 代码已落 `b2211b23fa5`；规则 16 回溯审查已做（2026-09-14）；仍 draft：S4a 诊断口、S4b fail-closed 竞态守卫、§5 手测（D405） |
