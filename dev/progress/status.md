...
| **F leftover** | WSL reconnect 四处双链；[D627](deferred-gaps.md)；未 commit；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D623](deferred-gaps.md)/[D627](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
