...
phase: N/A
updated: 2026-08-31
summary: "dev/plans 导航：M0 / M1 / M2 implemented；M3 in_progress"
---
...
| [m3-shell-closeout.md](m3-shell-closeout.md) | `in_progress` | 可选壳收尾：ChatEditor 默认路径藏/转、Navigator stub 会话列表；不阻塞无引擎完成线 |
