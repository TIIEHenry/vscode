...
| [packaging-and-release.md](packaging-and-release.md) | `accepted` | `gulp vscode-linux-x64` 验 `@grpc/grpc-js` 进包 + 活窗；无窗 asar 子集合同 [D388](../roadmap/active/d388-packaging-p1-asar-machine.md)（planned，未实施）；D18/D20 仍开 |
