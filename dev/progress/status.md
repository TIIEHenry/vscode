...
| **G** | `loop/G-d24-window-notify-leftover` — `_notify(session, newValue)` 双链；[D636](deferred-gaps.md)；D24 仍开；leftover 未全局完成；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D636](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
