...
created: 2026-08-30
updated: 2026-09-13
summary: "仓外 vscode-WorkTrees；基线 agent-ide；MERGE_SHA 733f8b368f8 已 push"
---
...
| 集成本次 HEAD | `733f8b368f8`（`loop/merge` · 2026-09-13 关仓；已 push `origin/agent-ide`） |
| 工位池 compile | compile-client 0 @ `733f8b368f8` |

## 槽位表（2026-09-13 · `MERGE_SHA`=`733f8b368f8`）

| 槽 | 路径 | 分支 | tip | 状态 |
|:---|:-----|:-----|:-----|:-----|
| merge | `vscode-WorkTrees/merge` | `loop/merge` | `733f8b368f8` | `parked`；== `origin/agent-ide` |
| A | `vscode-WorkTrees/A` | `loop/A` | `733f8b368f8` | `idle` |
...
| D | `vscode-WorkTrees/D` | `loop/D` | `733f8b368f8` | `idle` |
