...
phase: M7
updated: 2026-09-08
summary: "D16 / D31 F4 仍开。官方三域 glob 已绿。D44–D90 / D92–D129 / D131 / D133–D139 / D142 已闭。Rotate / 引擎 hook Revoke catch 已 error tone。swallowed primary 后 beside 已锁 notice。mermaid getExtension reject 已回 undefined。A2 仍 blocked。"
---
...
64. **D 槽 `mermaid-resolve-catch`（未关 D16 / D31）**：`resolveConversationMermaidExtension` 在 `getExtension` reject 时回 `undefined`，无未处理 rejection。[D142](deferred-gaps.md) **已闭**。未改 lens / mount fallback。未 compile。
子 agent 发现的既有代码问题：
| ID | 来源 | 问题 |
|:---|:-----|:-----|
