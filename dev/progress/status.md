...
phase: M7
updated: 2026-09-13
summary: "关仓中：A D426 / B D427 已进 merge；D D428 待合；D405/D429 仍开；未升 PRD-008"
---
...
| **D** | D428 Plugins KEEP leftover 行 toggle | `occupied` @ `9b8e74c8464` |
...
| [D405](deferred-gaps.md)–[D429](deferred-gaps.md) | A/B/D 本波 | D405 手测仍开；D413–D427 closed（D426 Tools KEEP / D427 MCP UNKNOWN）；[D429](deferred-gaps.md) Tools UNKNOWN leftover；D428 待合；不得宣称 leftover wave 完成 |
...
| **loop 切片** | 关仓中。A **D426** / B **D427** 已合。D D428 待合。**D405** 手测仍开。**D429** Tools UNKNOWN leftover 仍开。不关 D8/D16/D147。下号 **D429**。未升 PRD-008。 |
