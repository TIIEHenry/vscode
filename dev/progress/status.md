...
phase: M7
updated: 2026-09-16
summary: "G 已写 GetUploadProgress wire 未接线。D24 仍开。七条 RemoteAgent wire 未接线。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **G** | GetUploadProgress wire 未接线；勿 add `out`；D24 仍开 |
...
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：七条 **已** bytes；GetConfig/DeleteConfig/Reload/Destroy·Cancel·Resume/CheckConnection wire 未接线；G 已写 GetUploadProgress wire 未接线。仍勿关本行。Connect/SaveSkillContent/Watch 仍 JSON |
