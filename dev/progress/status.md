...
phase: M7
updated: 2026-09-17
summary: "F leftover D619：picker onSelect/restore 双链。mocha 3/0。未 commit。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **F** | `loop/F-d24-picker-dispatch-leftover`；onSelect/restore 双链 [D619](deferred-gaps.md)；mocha 3/0；未 commit。勿 add `out` |
...
| [D550](deferred-gaps.md)–[D615](deferred-gaps.md)/[D619](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
