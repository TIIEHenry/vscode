...
phase: M7
updated: 2026-09-16
summary: "merge 关仓：leftover D560–D567 关各 call site。工位 J 本刀 D575 关 openEditor 一处（未 commit）。compile-client 0。D24 仍开。不是 leftover/pills 完成。"
---
...
| [D575](deferred-gaps.md) | **closed** 本 call site only：list onDidOpen `openEditor` 双链；leftover **未**全局完成 |
