...
phase: M7
updated: 2026-09-17
summary: "SessionStream + L2 leftover 已合入。catch 含 D677–D713。A/D/G/I/J leftover 进行中。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **A/D/G/I/J** | leftover Promise 双链进行中（B 脏跳过；C gitlink 勿 add；E blocked；edit ff-only 失败） |
