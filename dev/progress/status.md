...
phase: M7
updated: 2026-09-16
summary: "F 本刀 StopLoop wire+测未接线。关仓 SwitchWorkDir/Compact/Todo/Usage/Status bytes 与 Pause/History/TestModelProfile/Back/Prune/Branch/Reset wire。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **F** | `loop/F-d24-stop-loop-unary-wire` StopLoop wire+测；未改 `grpcClient`；[D24](deferred-gaps.md) **仍开** |
...
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：五条 Agent unary **已** bytes；Pause/History/TestModelProfile/Back/Prune/Branch/Reset/StopLoop wire 未接线；ResolveTurn/Connect/SaveSkillContent/Watch·Rebuild 仍 JSON |
...
| 项 | 指针 |
|:---|:-----|
| **loop** | D24 仍开。A 下一刀接 Pause/History/Back/Prune/Branch/Reset/TestModelProfile/StopLoop。SaveSkillContent 无 RPC。Connect/Watch/ResolveAnchor 跳过。不得宣称 leftover/pills 完成 |
