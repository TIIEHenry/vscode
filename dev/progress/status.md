...
phase: M7
updated: 2026-09-16
summary: "D 槽 D516：Engine Preferences runEngineTest 两处双链 catch；未碰 OPEN_CONNECTION。D24 仍开。不是 leftover/pills 完成。"
---
...
| **D** | D516 | Engine Preferences `runEngineTest` 两处双链；未碰 OPEN_CONNECTION；未 compile-client；未 commit |
...
| [D516](deferred-gaps.md) | D | **closed** `runEngineTest` 两处双链；未碰 OPEN_CONNECTION；leftover **未**全局完成 |
...
| 项 | 指针 |
|:---|:-----|
| **loop 切片** | [D24](deferred-gaps.md) **仍开**（SaveSkillContent/Rebuild/Watch/GetModelPreferences/SetModelPreferences/ResolveModel 仍 JSON）。[D508](deferred-gaps.md)–[D514](deferred-gaps.md) / [D516](deferred-gaps.md) **closed**。[D487](deferred-gaps.md) **open**。不得宣称 leftover / pills 完成 |
