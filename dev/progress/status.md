...
phase: M7
updated: 2026-09-12
summary: "D391 可见性修复保留。D390/D392：直接 CLI 16g/32g 仍 OOM，dest 未写。D389 blocked。不关 D18/D20/D12。D393 未占用。"
---
...
| **loop 切片** | [D391](deferred-gaps.md) 可见性修复保留（mangler 过）。[D390](deferred-gaps.md)/[D392](deferred-gaps.md)：8192/env/直接 CLI 16g·32g 均 **exit 134**（CLI heap 已生效；dest 未写）。[D389](deferred-gaps.md) 仍 planned/blocked。不关 D18/D20（两行）/D12。**D393 未占用**。 |
