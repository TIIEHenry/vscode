...
|----|------|------|-----|:--|:------|:---------|
| merge | `vscode-WorkTrees/merge` | `loop/merge` | `e97f9d5b104` | `__pycache__` | 0 | parked；compile 基线 unused 仍红，**不 push** |
| A | `vscode-WorkTrees/A` | `loop/A` | `e97f9d5b104` | `__pycache__` | 0 | idle |
| B | `vscode-WorkTrees/B` | `loop/B` | `e97f9d5b104` | `__pycache__` | 0 | idle |
| C | `vscode-WorkTrees/C` | `loop/C` | `e97f9d5b104` | 未提交 `dev/loop` + `__pycache__` | 0 | idle；勿 add `dev/loop` |
| D | `vscode-WorkTrees/D` | `loop/D` | `e97f9d5b104` | `__pycache__` | 0 | idle |
| edit | `Projects/Agents/vscode` | `agent-ide` | `a40a95d1e85`+ | `dev/loop` + 过期 progress | 0 | 人类工位；请自行对齐 `e97f9d5b104` |
