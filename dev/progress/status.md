...
phase: M7
updated: 2026-09-16
summary: "关仓 SwitchWorkDir/Compact/Todo/Usage/Status bytes 与 Pause/History/TestModelProfile/Back/Prune/Branch/Reset wire。J 已写 FetchToolUsageDetail wire 未接线。compile-client 0。聚焦 59。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **J** | FetchToolUsageDetail wire 已落未接线；`context_sources`=3 unread；D24 仍开 |
...
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：五条 Agent unary **已** bytes；Pause/History/TestModelProfile/Back/Prune/Branch/Reset/FetchToolUsageDetail wire 未接线；ResolveTurn/Connect/SaveSkillContent/Watch·Rebuild 仍 JSON |
...
| 项 | 指针 |
|:---|:-----|
| **loop** | D24 仍开。A 下一刀接 Pause/History/Back/Prune/Branch/Reset/TestModelProfile/FetchToolUsageDetail。SaveSkillContent 无 RPC。Connect/Watch/ResolveAnchor 跳过。不得宣称 leftover/pills 完成 |
