...
phase: M7
updated: 2026-09-10
summary: "loop 关仓：本波 A–D 已合入 merge。D216–D221 已闭。D 槽 D225 Context Variables leftover 已收。compile-client 未跑。"
---
...
| **D** | context-variable-list-leftover | 工位 D [D225](deferred-gaps.md) 已闭；成功后再 list throw 保 leftover 行 + failed；首拉 throw 仍 empty+failed；勿 compile-client |
