...
phase: M7
updated: 2026-09-08
summary: "D16 / D31 F4 仍开。官方三域 glob 已绿。D44–D90 / D92–D114 已闭。Inbox enqueue false notice 已挂。A2 仍 blocked。"
---
...
61. **D100–D114**（未关 D16）：peek / close / opener / stale / save·delete·cancel·Stop·Goal·Enqueue false notice / reveal / open-beside / primary bootstrap notice；Goal 断连+history 可点；permission/question roster false notice。
子 agent 发现的既有代码问题：
| ID | 来源 | 问题 |
|:---|:-----|:-----|
...
| [D92](deferred-gaps.md)–[D114](deferred-gaps.md) | B roster+close / D nav / A beside+mru / A·B composer / D reveal / A delete·cancel / D beside+primary notice / B inbox Stop·Goal·Enqueue / A permission-question | **closed** throw 回滚/notice；peek；closeEditors；opener 回滚；stale；save/delete/cancel/Stop/Goal/Enqueue false 先 notice；reveal acquire；open-beside / primary bootstrap catch error notice；Goal 断连+history 可点；permission/question roster false notice；未关 D16 |
