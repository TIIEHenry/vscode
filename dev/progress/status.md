...
phase: M7
updated: 2026-09-16
summary: "merge 关仓：SaveConfig/CreateRemoteSession/Status/History/UploadProgress/ResolveModel 已 bytes；leftover D553–D559/D565 关各 call site。compile-client 0。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **H** | leftover [D565](deferred-gaps.md) `voiceModeOnboarding` `refreshMicrophones` 双链（~781/~782）；未 commit |
...
| [D550](deferred-gaps.md)–[D559](deferred-gaps.md)、[D565](deferred-gaps.md) | **closed** leftover catch（各 call site）；leftover **未**全局完成 |
