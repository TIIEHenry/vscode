...
phase: M7
updated: 2026-09-12
summary: "已合入 D364–D366（未编译）。D8/D16/D147 仍开。"
---
...
### 关仓（2026-09-12 · A D364 / B D365 / D D366 已合入；未 compile-client）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
...
| **D** | `history-post-await leftover-looks-live` [D366](deferred-gaps.md) | 已合入 `661e5ba9f3c`；in-flight getHistory 再检 KEEP |
...
| D | `vscode-WorkTrees/D` | `loop/D` | `661e5ba9f3c` | 干净 | 0 | 已收 D366 |
...
| **loop 切片** | [D364](deferred-gaps.md)–[D366](deferred-gaps.md) 已合入（未编译）。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto；未宣称 leftover-honesty 程序完成 |
