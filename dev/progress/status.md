...
phase: M7
updated: 2026-09-16
summary: "MERGE_SHA=`344c5bd5859` compile 0；D472 已闭（stub 链接改写）；R9 仍开；下号 D473；D405 手测仍开"
---
...
### 进行中（2026-09-16 · compile 0；A 已闭 D472）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | D472 stub/fixture 会话链接改写 | 已闭；禁 compile；R9 仍开 |
...
| [D405](deferred-gaps.md)–[D472](deferred-gaps.md) | A/D 本波 | D405 手测仍开；compile 0 @ `344c5bd5859`；D463/D466/D468–D470 / D472 已闭 |
...
| A | `vscode-WorkTrees/A` | `loop/A` | `344c5bd5859` | 干净 | 0 | D472 已闭；禁 compile |
...
| **loop 切片** | `MERGE_SHA`=`344c5bd5859`。compile 0。D472 已闭（R9 仍开）。下号 **D473**。**D405** 手测仍开。不关 D8/D16/D147。未升 PRD-008。不得宣称 leftover wave 完成。 |
