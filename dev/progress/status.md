...
| 槽 | 状态 |
|:---|:-----|
| **H** | D645 telemetry 24 处双链 catch；D24 仍开；leftover 未全局完成 |
...
| [D550](deferred-gaps.md)–[D639](deferred-gaps.md)/[D645](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
