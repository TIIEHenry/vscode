...
phase: M7
updated: 2026-09-08
summary: "D16 / D31 F4 仍开。官方三域 glob 已绿。D44–D90 / D92–D107 已闭。stale peek、composer/delete/cancel 拒绝 notice 与 reveal acquire catch 已挂。A2 仍 blocked。"
---
...
61. **D100–D107**（未关 D16）：peek / closeEditors / opener 回滚 / stale / save·delete·cancel false 先 notice / reveal acquire。
子 agent 发现的既有代码问题：
| ID | 来源 | 问题 |
|:---|:-----|:-----|
...
| [D92](deferred-gaps.md)–[D107](deferred-gaps.md) | B roster+close / D nav / A beside+mru / A·B composer / D reveal / A delete·cancel | **closed** throw 回滚/notice；peek；closeEditors；opener 回滚；stale；save/delete/cancel false 先 notice；reveal acquire；未关 D16 |
