...
phase: M7
updated: 2026-09-16
summary: "A 工位 Session Prewarm/Shelve/Unshelve/Purge/Export grpcClient 已 bytes；D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **A** | Session Prewarm/Shelve/Unshelve/Purge/Export **已** bytes（未关 D24；未 commit） |
...
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：Session 五 lifecycle unary **已** bytes；SaveSkillContent/Rebuild/Watch/model prefs/Connect 仍 JSON |
...
| 项 | 指针 |
|:---|:-----|
| **loop** | D24 仍开（SaveSkillContent 无 proto / Watch / model prefs / Connect）。Session Prewarm/Shelve/Unshelve/Purge/Export 已 bytes。`conversationLensSessionBar` helper 仍裸 void。不得宣称 leftover/pills 完成 |
