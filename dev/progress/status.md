...
phase: M7
updated: 2026-09-12
summary: "已关仓 D346–D348。已收 D349（未提交）。D8/D16/D147 仍开。"
---
...
### 关仓（2026-09-12 · A D346 / B D347 / D D348 已关仓；A 已收 D349（未提交）；compile-client 0）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | `snapshots-first-pull-leftover-looks-live` [D346](deferred-gaps.md) | `already-committed` `98f90c8e18b`；Snapshots 首拉 leftover 写闸 |
| **A** | `catalog-first-pull-leftover-looks-live` [D349](deferred-gaps.md) | 已收 D349（未提交）；Skills/Tools/Agents/Plugins 首拉 leftover 写闸 |
| **B** | `clipboard-first-pull-leftover-looks-live` [D347](deferred-gaps.md) | `already-committed` `7b8ebb00f0e`；Clipboard 首拉 leftover 写闸 |
...
| A | `vscode-WorkTrees/A` | `loop/A` | 跟 MERGE_SHA | 未提交 D349 | 0 | 已收 D349（未提交） |
| B | `vscode-WorkTrees/B` | `loop/B` | 跟 MERGE_SHA | 干净 | 0 | 已收 D347 |
...
| **loop 切片** | [D346](deferred-gaps.md)–[D348](deferred-gaps.md) 已关仓。已收 [D349](deferred-gaps.md)（未提交）。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto |
