...
phase: N/A
updated: 2026-09-12
summary: "行动层 roadmap 入口；D390 planned（直接 CLI 16g/32g 仍 OOM，dest 未写）；D389 planned（prepare-deb 三次 sysroot blocked）；D388 已闭（未提交）"
---
...
| [D390 packaging-p2-vscode-web-machine](active/d390-packaging-p2-vscode-web-machine.md) | `active` / deferred-gaps `planned`（实施 blocked：直接 CLI 16g/32g OOM；dest 未写） | 无窗 vscode-web 排除面：dest 独占；产物树无 `@grpc/grpc-js`；不关 D389/D18/D20（两行）/D12 |
