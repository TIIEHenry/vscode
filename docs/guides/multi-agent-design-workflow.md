...
phase: N/A
updated: 2026-08-31
summary: "方案定稿前的多 agent 探索；并行 slice、文件互斥与 worktree 池 / merge 槽合入流程"
---
...
3. **实施**：按 [dev/loop/workflow.md](../../dev/loop/workflow.md) 开 Loop tick；每 slice 占字母槽，遵守冲突矩阵与 merge 流程。
