...
phase: M7
updated: 2026-09-12
summary: "A 已收 D361（未提交）。D8/D16/D147 仍开。"
---
...
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | `sources-review-attribution leftover-looks-live` [D361](deferred-gaps.md) | 已收 D361（未提交）；pairing-hold-first 不从 `isEngineConnected()` 单设 everConnected |
...
| A | `vscode-WorkTrees/A` | `loop/A` | 跟 MERGE_SHA | 脏 | 0 | idle；已收 D361（未提交） |
...
| **loop 切片** | [D361](deferred-gaps.md) 已收（未提交）。下一未占用 ID **D362**。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto；未宣称 leftover-honesty 程序完成 |
