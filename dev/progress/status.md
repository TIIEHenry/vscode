...
phase: M7
updated: 2026-09-13
summary: "A occupied D416：用户重连非 TE throw 再拨；385/0；D405/D415/D417 仍开；下号 D418"
---
...
### 进行中（2026-09-13 · MERGE_SHA 已钉；A occupied D416；B/D idle）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | `d416-user-reconnect-throw` | `occupied`；用户重连非 TE throw 再拨；385/0 |
| **B** | — | `idle`；HEAD == MERGE_SHA |
...
| **loop 切片** | `MERGE_SHA`=`200fa7c3172`。A `occupied` D416（385/0）。**D405** 手测仍开。**D415/D417** 仍开。**D416** 已闭。不关 D8/D16/D147。下号 **D418**。未升 PRD-008。 |
