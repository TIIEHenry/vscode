...
phase: M7
updated: 2026-09-08
summary: "D16 / D31 F4 仍开。官方三域 glob 已绿。D44–D90 / D92–D119 / D121 已闭。live-tree acquire throw 已吞。A2 仍 blocked。"
---
...
62. **B 槽 `session-chat-livetree-acquire-catch`（未关 D16）**：`bindLiveTreeLease` acquire throw → notice，不挂 lease。[D121](deferred-gaps.md) **已闭**。
子 agent 发现的既有代码问题：
| ID | 来源 | 问题 |
|:---|:-----|:-----|
...
| [D121](deferred-gaps.md) | B 槽 `session-chat-livetree-acquire-catch` | **closed** `bindLiveTreeLease` acquire throw 已 notice、不挂 lease；未关 D16 |
