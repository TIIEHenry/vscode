...
phase: M7
updated: 2026-09-16
summary: "关仓五条 Agent bytes 与七条 Agent wire。C 本刀 SuspendLoop wire 未接线。D24 仍开。不是 leftover/pills 完成。"
---
...
| **C** | SuspendLoop wire 未接线；勿 add `dev/loop`；D24 仍开 |
...
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：五条 Agent unary **已** bytes；Pause/History/TestModelProfile/Back/Prune/Branch/Reset/SuspendLoop wire 未接线；ResolveTurn/Connect/SaveSkillContent/Watch·Rebuild 仍 JSON |
...
| 项 | 指针 |
|:---|:-----|
| **loop** | D24 仍开。C SuspendLoop wire 未接线。A 下一刀接 Pause/History/Back/Prune/Branch/Reset/TestModelProfile。SaveSkillContent 无 RPC。Connect/Watch/ResolveAnchor 跳过。不得宣称 leftover/pills 完成 |
