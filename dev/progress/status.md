...
phase: M7
updated: 2026-09-16
summary: "I leftover：voiceTranscriptsView 两处 void refresh 双链，D558 关 call site。未改 voiceEventStreamView。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **I leftover** | `voiceTranscriptsView` 两处 `void refresh` 双链；[D558](deferred-gaps.md) 关 call site。未改 `voiceEventStreamView`。未 commit |
...
| [D550](deferred-gaps.md)–[D552](deferred-gaps.md)/[D558](deferred-gaps.md) | **closed** leftover catch（D558 仅 transcriptsView 两处）；leftover **未**全局完成 |
