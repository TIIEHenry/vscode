...
phase: M7
updated: 2026-09-11
summary: "GitHub Actions 永久关闭（见 workflows/DISABLED.md）。loop：D276–D280 已进 merge；compile-client 待本合入。"
---
...
|----|------|------|-----|:--|:------|:---------|
| merge | `vscode-WorkTrees/merge` | `loop/merge` | `fdf32fe69d9` | 干净 | 0 | D280 已合；compile 待跑 |
| A | `vscode-WorkTrees/A` | `loop/A` | `1b3d3ef6e16` | 干净 | 0 | idle；待 cascade |
| B | `vscode-WorkTrees/B` | `loop/B` | `bf812ce09f4` | 干净 | 0 | 已进 merge；D280 已闭 |
| C | `vscode-WorkTrees/C` | `loop/C` | `1b3d3ef6e16` | 未提交 `dev/loop` | 0 | idle；勿 add `dev/loop` |
| D | `vscode-WorkTrees/D` | `loop/D` | `1b3d3ef6e16` | 干净 | 0 | idle；待 cascade |
...
| **loop 切片** | [D280](deferred-gaps.md) 已进 merge。compile-client 待本合入。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto |
