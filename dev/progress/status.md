...
phase: M7
updated: 2026-09-11
summary: "GitHub Actions 永久关闭（见 workflows/DISABLED.md）。loop A 槽 D279 Plugins/MCP Runtime 详情 leftover 已落未 commit；compile-client 待复跑。"
---
...
### 进行中（2026-09-11 · loop 重启 · 四槽并行）
| 槽 | 切片 | 状态 |
|:---|:-----|:-----|
| **A** | catalog-plugins-mcp-runtime-detail-leftover | 工位代码已落 [D279](deferred-gaps.md)；未 commit |
| **B** | — | idle；对齐 `ad9245ca178`；D278 留给 pairing×catalog |
| **C** | catalog-detail-rpc-leftover | 已进 merge；[D275](deferred-gaps.md) 已闭；勿 add `dev/loop` |
| **D** | — | idle；对齐 `ad9245ca178` |
...
| [D242](deferred-gaps.md)–[D275](deferred-gaps.md) / [D277](deferred-gaps.md) / [D279](deferred-gaps.md) | leftover + pairing | **closed** catalog leftover + Overview Model + Sources no-hook + Activity fetch-fail + 详情二次 throw + H4b pairing；**D279** Plugins hooks / MCP Runtime tools 详情 leftover（A 槽已落未 commit） |
...
|----|------|------|-----|:--|:------|:---------|
| merge | `vscode-WorkTrees/merge` | `loop/merge` | 本 C 合入 | 干净 | 0 | 已合 A+C；未 push |
| A | `vscode-WorkTrees/A` | `loop/A` | `0e3b09d3f89` + D279 未提交 | 本切片 6 文件 | 0 | D279 已落；未 commit |
| B | `vscode-WorkTrees/B` | `loop/B` | `ad9245ca178` | 干净 | 0 | idle |
| C | `vscode-WorkTrees/C` | `loop/C` | `01f4c90497c` | 未提交 `dev/loop` | 0 | 已合入 merge（D275）；勿 add `dev/loop` |
| D | `vscode-WorkTrees/D` | `loop/D` | `ad9245ca178` | 干净 | 0 | idle |
...
| **loop 切片** | D273–D275 / D277 已进 merge。A 槽 D279 Plugins/MCP Runtime 详情 leftover 已落未 commit。排队 D276 Read leftover、D278 pairing×catalog（B）。compile-client 待复跑。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto |
