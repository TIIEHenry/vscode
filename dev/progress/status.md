...
phase: M7
updated: 2026-09-08
summary: "D16 / D31 F4 仍开。官方三域 glob 已绿。D44–D90 / D92–D110 已闭。delete/cancel、open-beside 与 Inbox Stop/Goal notice 已挂。A2 仍 blocked。"
---
...
61. **D100–D110**（未关 D16）：peek / close / opener / stale / save·delete·cancel·Stop·Goal false notice / reveal / open-beside。
子 agent 发现的既有代码问题：
| ID | 来源 | 问题 |
|:---|:-----|:-----|
...
| [D92](deferred-gaps.md)–[D110](deferred-gaps.md) | B roster+close / D nav / A beside+mru / A·B composer / D reveal / A delete·cancel / D beside notice / B inbox Stop·Goal | **closed** throw 回滚/notice；peek；closeEditors；opener 回滚；stale；save/delete/cancel/Stop/Goal false 先 notice；reveal acquire；open-beside catch error notice；未关 D16 |
