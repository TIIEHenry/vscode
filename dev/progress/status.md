...
phase: M7
updated: 2026-09-16
summary: "G 本刀 Agent.Back wire 已落未接线。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **G** | Back wire 已落未接线；D24 仍开；勿 add `out` |
...
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：Clear/Get·SetModelPreferences **已** bytes；SwitchWorkDir/Compact/Todo/Usage/Status/Back wire 未接线；ResolveTurn/Connect/SaveSkillContent/Watch·Rebuild 仍 JSON |
...
| 项 | 指针 |
|:---|:-----|
| **loop** | D24 仍开。A 下一刀接 SwitchWorkDir/Compact/Todo/Usage/Status/Back。SaveSkillContent 无 RPC。Connect/Watch 跳过。不得宣称 leftover/pills 完成 |
