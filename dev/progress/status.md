...
phase: M7
updated: 2026-09-17
summary: "F：D635 browsers `_openBrowser` 双链。D24 仍开。不是 leftover/pills 完成。"
---
...
| **F** | D635 `sessionBrowsersControl` `_openBrowser` 双链；本 call site only；D24 仍开；leftover 未全局完成 |
...
| [D550](deferred-gaps.md)–[D635](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
