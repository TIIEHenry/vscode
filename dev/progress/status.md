...
| **C** | changes-git-read-leftover | [D244](deferred-gaps.md) 已闭；活画后再 git-read throw 保 leftover；勿 add `dev/loop` |
...
| **loop 切片** | D238–D241 已 compile-client 0；下一波从代码搜 leftover（D242+）。勿派 D147 / 勿开 F3·A2 / 勿发明 proto / 勿改引擎仓 |
