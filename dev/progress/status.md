...
phase: M7
updated: 2026-09-16
summary: "merge 关仓：leftover D560–D567 关各 call site。工位 A 本刀 D568 关 startPreview 两处（未 commit）。compile-client 0。D24 仍开。不是 leftover/pills 完成。"
---
...
| [D550](deferred-gaps.md)–[D568](deferred-gaps.md) | **closed** leftover catch（D568 只关 startPreview 两处）；leftover **未**全局完成 |
| [D8](deferred-gaps.md)/[D16](deferred-gaps.md)/[D147](deferred-gaps.md)/[D405](deferred-gaps.md)/[R9](research-queue.md) | **仍开** |
## Next
| 项 | 指针 |
|:---|:-----|
| **loop** | D24 仍开。D568 只关 dictation `startPreview` 两处。SaveSkillContent 无 RPC。Connect/Watch/ResolveAnchor/ResolveTurn 跳过。不得宣称 leftover/pills 完成 |
