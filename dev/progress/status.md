...
| **F** | leftover D643 `_openEmptyFiles` finally+双链；D24 仍开；leftover 未全局完成 |
...
| [D643](deferred-gaps.md) | **closed** `_openEmptyFiles` finally+双链；本 call site only；leftover **未**全局完成 |
