...
phase: M7
updated: 2026-09-16
summary: "D 已写 DeleteConfig wire 未接线。仍勿关本行。七条 loop/tool 已 bytes；SendShell/ListNodes/GetNode/Maintenance/ResetError/ListConfigs wire 未接线。compile-client 0。D24 仍开。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **D** | 已写 DeleteConfig wire 未接线。仍勿关本行 |
...
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：D 已写 DeleteConfig wire 未接线。七条 loop/tool **已** bytes；SendShell/ListNodes/GetNode/Maintenance/ResetError/ListConfigs 未接线；ResolveTurn/Connect/SaveSkillContent 仍 JSON |
