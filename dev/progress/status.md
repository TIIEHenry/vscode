...
phase: M7
updated: 2026-09-13
summary: "MERGE_SHA=`733f8b368f8` / ledger `9aeca80c4c2`；D443 Sources ApplyHunks leftover 关 Accept helper 门已落地未提交；D405 仍开；下号 D444；不得宣称 leftover wave 完成"
---
...
### 进行中（2026-09-13 · D443 已落地未提交）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | D443 Sources ApplyHunks leftover 关 Accept helper 门 | 已落地未提交；MERGE_SHA 仍 `733f8b368f8` / ledger `9aeca80c4c2` |
...
| [D405](deferred-gaps.md)–[D443](deferred-gaps.md) | A/B/D 本波 | D405 手测仍开；D413–D443 closed（D443 ApplyHunks leftover 关 Accept helper 门已落地未提交）；不得宣称 leftover wave 完成 |
## 工位表（P7 · 2026-09-13 · 与 `git worktree list` 对照）
| 槽 | 路径 | 分支 | tip | 脏 | stash | 关仓状态 |
|----|------|------|-----|:--|:------|:---------|
| merge | `vscode-WorkTrees/merge` | `loop/merge` | `733f8b368f8` | 干净 | 0 | `parked`；MERGE_SHA；compile-client 0；已 push |
| A | `vscode-WorkTrees/A` | `loop/A` | `9aeca80c4c2` | 脏 D443 | 0 | D443 已落地未提交；MERGE_SHA 仍 `733f8b368f8` |
...
| D | `vscode-WorkTrees/D` | `loop/D` | `733f8b368f8` | 干净 | 0 | `idle`；跟 MERGE_SHA |
...
| **loop 切片** | `MERGE_SHA`=`733f8b368f8` / ledger `9aeca80c4c2`。**D435**–**D442** 已合；**D443** 工位 A 已落地未提交（ApplyHunks leftover 关 Accept helper 门）。下号 **D444**。**D405** 手测仍开。不关 D8/D16/D147。未升 PRD-008。不得宣称 leftover wave 完成。不占 D444。 |
