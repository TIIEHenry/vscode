...
phase: M7
updated: 2026-09-14
summary: "MERGE_SHA=`a653fc086aa` 已 push；compile-client 0；D446 Sources leftover pairing-hold onDidOpen + Open Selected FileDiff 已落本树；D405 仍开；下号 D447"
---
...
### 进行中（2026-09-14 · D446 Sources leftover onDidOpen / Open Selected）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | D446 Sources leftover pairing-hold onDidOpen + Open Selected FileDiff | 已落本树；未合；未宣称 leftover wave 完成 |
| **B** | — | 脏 `worktree-pool.md` 勿 add / 勿 `-B` |
| **C** | — | 脏 `dev/loop`；勿 add / 勿 `-B` |
| **D** | D445 Navigator leftover Inspect / Reveal / 开行 / 切会话 | 已合入；跟 MERGE_SHA |
...
| [D405](deferred-gaps.md)–[D446](deferred-gaps.md) | A/B/D 本波 | D405 手测仍开；D444/D445 已合；D446 已落本树（pairing-hold leftover 开行 + Open Selected FileDiff）；不得宣称 leftover wave 完成 |
...
| D | `vscode-WorkTrees/D` | `loop/D` | `a653fc086aa` | 干净 | 0 | `idle`；跟 MERGE_SHA |
...
| **loop 切片** | `MERGE_SHA`=`a653fc086aa`。**D446** 已落本树（未合）。下号 **D447**。**D405** 手测仍开。不关 D8/D16/D147。未升 PRD-008。不得宣称 leftover wave 完成。 |
