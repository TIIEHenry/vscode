...
### 关仓（2026-09-12 · A D315 + B D316；前波 D311–D314 已在库）
| 槽 | 切片 | 关仓状态 |
|:---|:-----|:---------|
| **A** | `diff-review-accept-leftover-writes` [D315](deferred-gaps.md) | `already-committed` `7cf0e3389d6`；Diff/Review Accept leftover 写闸 |
