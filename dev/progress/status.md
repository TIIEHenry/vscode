...
| 槽 | 状态 |
|:---|:-----|
| **C** | leftover D641 contextView onDidOpen revealFeedback 双链；[D641](deferred-gaps.md)；未 commit；gitlink 脏勿 add；D24 仍开 |
...
| [D550](deferred-gaps.md)–[D641](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
