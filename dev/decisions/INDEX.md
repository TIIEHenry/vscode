...
phase: N/A
updated: 2026-09-02
summary: "本仓库本地 ADR 索引；ADR-005 Diff owner 已接受；ADR-004 已被 ADR-005 取代；ADR-003 引擎 adapter 边界 accepted；ADR-002 session 窗口已接受已实施"
---
...
| [003-engine-adapter-boundary.md](003-engine-adapter-boundary.md) | `accepted` | UA 传输落 platform/universeAgent；roster 同 token `'conversationStubService'`；AHP 非权威；stream-timeline §9 已并入 |
