...
phase: M7
updated: 2026-09-17
summary: "D 槽 D610：newChatInput dictation handler 双链。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **D** | `loop/D-d24-newchat-handler-leftover` handler 双链；[D610](deferred-gaps.md)；未 commit |
...
| [D550](deferred-gaps.md)–[D610](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
