...
phase: M7
updated: 2026-09-16
summary: "merge 关仓：GetConfig/DeleteConfig/Reload/Destroy·Cancel·Resume/CheckConnection 已 bytes；Status/History/CreateRemoteSession/UploadProgress/ResolveModel/SaveConfig wire 未接线；host leftover D552 关五处。G 槽 pluginListWidget 七处 refresh 双链，D556 关 call site。compile-client 0。D24 仍开。不是 leftover/pills 完成。"
---
...
| **G leftover** | `pluginListWidget` 七处 `void this.refresh()` 双链；[D556](deferred-gaps.md) 关 call site。未 commit。D24 仍开。不是 leftover 完成 |
...
| [D550](deferred-gaps.md)–[D552](deferred-gaps.md)/[D556](deferred-gaps.md) | **closed** leftover catch（D556 仅 pluginList 七处 refresh）；leftover **未**全局完成 |
| [D8](deferred-gaps.md)/[D16](deferred-gaps.md)/[D147](deferred-gaps.md)/[D405](deferred-gaps.md)/[R9](research-queue.md) | **仍开** |
## Next
| 项 | 指针 |
|:---|:-----|
| **loop** | D24 仍开。A 下一刀接上述六条 wire。SaveSkillContent 无 RPC。Connect/Watch/ResolveAnchor 跳过。不得宣称 leftover/pills 完成 |
