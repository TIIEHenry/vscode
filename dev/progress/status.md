...
phase: M7
updated: 2026-09-16
summary: "H 槽 Todo unary wire 已落；grpcClient 仍 JSON。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **H** | Todo unary wire 已落；grpcClient 仍 JSON；[D24](deferred-gaps.md) **仍开** |
...
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：Todo wire **已**落、grpcClient **仍** JSON；webhook/demoFake **已** bytes；ClearSessionDemoFake / Get·SetModelPreferences / ResolveTurn / Connect / SaveSkillContent / Watch·Rebuild 仍 JSON |
...
| 项 | 指针 |
|:---|:-----|
| **loop** | D24 仍开。Todo wire 已落、grpcClient 仍 JSON。Connect/Watch 跳过。不得宣称 leftover/pills 完成 |
