...
| **H leftover** | `_openBlockedSession` openSessionToSide / openSession 双链；[D629](deferred-gaps.md)；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D623](deferred-gaps.md)、[D629](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
