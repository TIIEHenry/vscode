...
phase: M7
updated: 2026-09-16
summary: "G 槽 pluginListWidget queryMarketplaceSnapshot/queryMarketplace 双链；D564 只关这些 call site。D24 仍开。不是 leftover/pills 完成。勿 add out。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **G** | `loop/G-d24-plugin-query-leftover`；query 双链；[D564](deferred-gaps.md)；勿 add `out`；未 commit |
...
| [D550](deferred-gaps.md)–[D559](deferred-gaps.md)/[D564](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
