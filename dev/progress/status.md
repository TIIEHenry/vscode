...
phase: M7
updated: 2026-09-17
summary: "工位 D leftover D578 关 sessionsSignInDialog show 一处。compile-client 0。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **D** | leftover `sessionsSignInDialog` `void this.show()` 双链；[D578](deferred-gaps.md) 本 call site 已闭；未 commit；D24 仍开 |
...
| [D550](deferred-gaps.md)–[D575](deferred-gaps.md)/[D578](deferred-gaps.md) | **closed** leftover catch（本刀仅 D578 一处）；leftover **未**全局完成 |
