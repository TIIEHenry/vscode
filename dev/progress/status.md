...
### 进行中（2026-09-14 · D446/D447 已合；compile-client 0）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
...
| [D405](deferred-gaps.md)–[D447](deferred-gaps.md) | A/B/D 本波 | D405 手测仍开；D446/D447 已合 `d1d02671540`（FileDiff leftover 开行 + leftover keep-last）；不得宣称 leftover wave 完成 |
