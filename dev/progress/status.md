...
phase: M7
updated: 2026-09-17
summary: "工位 G leftover：pluginList 两处 installMarketplacePlugin 双链（D580 仅这些 call site，未 commit）。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **G** | leftover-plugin-install：两处 `installMarketplacePlugin` 双链；[D580](deferred-gaps.md) 关这些 call site；未 commit；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D575](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
| [D580](deferred-gaps.md) | **closed** 仅 pluginList 两处 installMarketplacePlugin；leftover **未**全局完成 |
