...
phase: M7
updated: 2026-09-16
summary: "工位 G leftover：D572 关 pluginList 两处 filterPlugins 双链。compile-client 0。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **G** | leftover-plugin-filter：两处 `filterPlugins` 双链；[D572](deferred-gaps.md)；未 commit；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D567](deferred-gaps.md)、[D572](deferred-gaps.md) | **closed** leftover catch（各 call site）；leftover **未**全局完成 |
