...
phase: M7
updated: 2026-09-10
summary: "loop 关仓：本波 A–D 已合入 merge。D198 / D207–D211 已闭。B 槽 D214 Projects rebuildTree throw 标 stale。待一路 compile。"
---
...
| **B** | navigator-projects-rebuild-throw-stale | `loop/B` 已收；[D214](deferred-gaps.md) 已闭（A/C/merge 占到 D213）；D207 未撤 |
