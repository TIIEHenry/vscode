...
created: 2026-08-30
updated: 2026-09-08
summary: "延期缺口 SSOT；D16 仍开；D45 host open throw-on-open 已 catch；D46 Tools/Agents leftover 行已清；D47 closeStream dispose throw 已 catch；D48 其余 host dispose throw 已 catch；D22 F3；D24 其余 JSON RPC；D25 引擎 List 真空；D26 引擎建壳回 6；D31 F4 / A2 blocked；git-read throw 与列表 open-diff status DOM 已挂载"
---
