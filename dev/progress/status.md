...
phase: M7
updated: 2026-09-12
summary: "已合入 D361–D362（未编译）。D8/D16/D147 仍开。"
---
...
### 关仓（2026-09-12 · A D361 / B D362 已合入；未 compile-client）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | `sources-review-attribution leftover-looks-live` [D361](deferred-gaps.md) | 已合入 `96f645a8bb5`；pairing-hold-first 不从 `isEngineConnected()` 单设 everConnected |
| **B** | `connection-pane-engine-pair-seat` [D362](deferred-gaps.md) | 已合入 `17a1205bd54`；leftover-looks-live signedOut 藏 Hub devices |
...
| A | `vscode-WorkTrees/A` | `loop/A` | `96f645a8bb5` | 干净 | 0 | 已收 D361 |
| B | `vscode-WorkTrees/B` | `loop/B` | `17a1205bd54` | 干净 | 0 | 已收 D362 |
...
| **loop 切片** | [D361](deferred-gaps.md)–[D362](deferred-gaps.md) 已合入（未编译）。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto；未宣称 leftover-honesty 程序完成 |
