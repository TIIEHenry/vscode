...
| **C** | leftover `loop/C-d24-turn-changes-leftover` | D625 四处 `_openSessionTurnChanges` 双链；gitlink 脏勿 add |
...
| [D550](deferred-gaps.md)–[D623](deferred-gaps.md)/[D625](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
