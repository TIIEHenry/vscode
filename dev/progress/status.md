...
| 槽 | 状态 |
|:---|:-----|
| **D** | revealCI `_revealPullRequest` 双链；[D626](deferred-gaps.md)；未 commit。勿 add `out`。D24 仍开 |
...
| [D550](deferred-gaps.md)–[D626](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
