...
phase: M7
updated: 2026-09-17
summary: "H leftover D597：sessionChangesEditor middle-click executeCommand 双链。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **H** | leftover `sessionChangesEditor` middle-click executeCommand 双链；[D597](deferred-gaps.md)；未 commit。D24 仍开。不是 leftover/pills 完成 |
...
| [D550](deferred-gaps.md)–[D591](deferred-gaps.md)/[D597](deferred-gaps.md) | **closed** leftover catch（各 call site）；leftover **未**全局完成 |
