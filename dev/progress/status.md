...
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：`makeClientStreamBytesClient` 已落、Upload 未接线；Connect/SaveSkillContent/Watch/ResolveTurn/ResolveAnchor 仍 JSON |
...
| 项 | 指针 |
|:---|:-----|
| **loop** | D24 仍开。G 本刀只加 `makeClientStreamBytesClient`。下一刀接线 SubscribeToolDetail/Rebuild/RemoteChat/Download；Upload 再接线 bytes client-stream。SaveSkillContent 无 RPC。Connect/Watch/ResolveAnchor/ResolveTurn 跳过。不得宣称 leftover/pills 完成 |
