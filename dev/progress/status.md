...
phase: M7
updated: 2026-09-11
summary: "GitHub Actions 永久关闭（见 workflows/DISABLED.md）。loop：D276/D278/D279 已进 merge；D280 排队；compile-client 待本合入。"
---
...
### 进行中（2026-09-11 · A/B/D 已进 merge）
| 槽 | 切片 | 状态 |
|:---|:-----|:-----|
| **A** | catalog-plugins-mcp-runtime-detail | 已进 merge；[D279](deferred-gaps.md) 已闭 |
| **B** | pairing-catalog-keep-last | 已进 merge；[D278](deferred-gaps.md) 已闭 |
...
| [D242](deferred-gaps.md)–[D279](deferred-gaps.md) | leftover + pairing | **closed** catalog leftover + UNKNOWN leftover + H4b + Plugins/Runtime 详情 + pairing keep-last；[D280](deferred-gaps.md) 其余 pairing 仍开 |
...
|----|------|------|-----|:--|:------|:---------|
| merge | `vscode-WorkTrees/merge` | `loop/merge` | 本 B 合入 | 干净 | 0 | D276+D278+D279；compile 待跑 |
| A | `vscode-WorkTrees/A` | `loop/A` | `56db32094f7` | 干净 | 0 | 已进 merge；D279 已闭 |
| B | `vscode-WorkTrees/B` | `loop/B` | `c37629f2972` | 干净 | 0 | 已进 merge；D278 已闭 |
...
| **loop 切片** | D276/D278/D279 已进 merge。[D280](deferred-gaps.md) 其余 catalog pairing 排队。compile-client 待本合入。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto |
