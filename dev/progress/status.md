...
| 槽 | 状态 |
|:---|:-----|
| **D** | GetRemoteSessionHistory wire（messages unread）未接线；勿关 D24 |
...
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：七条 **已** bytes；GetConfig/DeleteConfig/Reload/Destroy·Cancel·Resume/CheckConnection/GetRemoteSessionHistory wire 未接线；Connect/SaveSkillContent/Watch 仍 JSON |
