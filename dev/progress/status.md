...
phase: M7
updated: 2026-09-12
summary: "D326–D330 已关仓。D8/D16/D147 仍开。"
---
...
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | `roster-queue-canceltool-leftover-looks-live` [D330](deferred-gaps.md) | `already-committed` `e5982be9467`；roster cancelToolCall + queue leftover 写闸 |
...
| A | `vscode-WorkTrees/A` | `loop/A` | 已收 D330 | 干净 | 0 | 已收 D330 |
...
| **loop 切片** | [D326](deferred-gaps.md)–[D330](deferred-gaps.md) 已关仓；compile-client 0。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto |
