...
phase: M7
updated: 2026-09-12
summary: "已关仓 D370–D372 compile-client 0。已收 D374（未提交）。D8/D16/D147 仍开。"
---
...
### 关仓（2026-09-12 · A D370 / B D371 / D D372 compile-client 0）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | `inbox-enqueue-post-await leftover-looks-live` [D370](deferred-gaps.md) | 已关仓 `8ce500447aa`；Enqueue mid-await pairing-hold 0 enqueue |
| **B** | `create-snapshot-post-await leftover-looks-live` [D371](deferred-gaps.md) | 已关仓 `34660517c96`；prompt 后 leftover-looks-live 0 createSnapshot |
| **D** | `plugins-loadInfo leftover-looks-live` [D372](deferred-gaps.md) | 已关仓 `d7781b61708`；loadInfo leftover-looks-live 0 extra |
| **E** | [composer-fake-chrome](../plans/composer-fake-chrome.md) | leftover 已在库；勿 `checkout -B` |

已收 D374（未提交）：roster leftover-looks-live KEEP-chrome 降 live/syncing、首拉不翻 `wasEverConnected`、pairing-hold 不 advertise。
...
| A | `vscode-WorkTrees/A` | `loop/A` | `8ce500447aa` | 干净 | 0 | 已收 D370 |
| B | `vscode-WorkTrees/B` | `loop/B` | `17db18ffc2f` | 脏 | 0 | 已收 D374（未提交） |
| C | `vscode-WorkTrees/C` | `loop/C` | 跟 MERGE_SHA | 未提交 `dev/loop` | 0 | idle；勿 add `dev/loop` |
| D | `vscode-WorkTrees/D` | `loop/D` | `d7781b61708` | 干净 | 0 | 已收 D372 |
...
| **loop 切片** | [D370](deferred-gaps.md)–[D372](deferred-gaps.md) 已关仓 compile-client 0。工位 B **已收 D374（未提交）**。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto；未宣称 leftover-honesty 程序完成 |
