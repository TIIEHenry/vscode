...
phase: M7
updated: 2026-09-16
summary: "merge 关仓 D560–D567。F 本刀 D571 关 mcpList executeCommand 三处。compile-client 0。D24 仍开。不是 leftover/pills 完成。"
---
...
| **F leftover** | mcpList executeCommand 三处双链；[D571](deferred-gaps.md) 关这些 call site；D24 仍开；leftover 未全局完成 |
...
| [D550](deferred-gaps.md)–[D567](deferred-gaps.md)、[D571](deferred-gaps.md) | **closed** leftover catch（D571 仅 mcpList executeCommand 三处）；leftover **未**全局完成 |
