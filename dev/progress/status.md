...
phase: M7
updated: 2026-09-16
summary: "I 槽 Usage wire 已落（嵌套 10/11 unread）。grpcClient 仍 JSON。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **I** | `loop/I-d24-usage-unary-wire`：Usage wire+测已落；未接 grpcClient；未关 D24 |
...
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：Usage wire 已落（嵌套 10/11 unread），grpcClient 仍 JSON；webhook/demoFake **已** bytes |
...
| 项 | 指针 |
|:---|:-----|
| **loop** | D24 仍开。Usage wire 已落（嵌套 10/11 unread），grpcClient 仍 JSON。不得宣称 leftover/pills 完成 |
