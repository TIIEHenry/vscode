...
phase: M7
updated: 2026-09-12
summary: "关仓 MERGE_SHA 969d9f4831be 已 push origin/agent-ide；compile-client 0；D405 手测仍开；B occupied D411 Test Engine tone；未升 PRD-008"
---
...
| [D405](deferred-gaps.md)–[D411](deferred-gaps.md) | A/B 本波 | D405 **仍开**（§5 手测未跑）；D406–D409 **closed**；D411 **代码+测已收、待 merge**（`enginePreferencesPane.test.ts` 19 passing / 0 fail）；B **occupied D411**；未升 PRD-008 |
...
| B | `vscode-WorkTrees/B` | `loop/B` | `03aef120e5a` | D411 | 0 | `occupied`；Test Engine tone |
...
| **loop 切片** | **MERGE_SHA `969d9f4831be`** 已 push。B **occupied D411**（代码+测已收、待 merge；`enginePreferencesPane.test.ts` 19 passing / 0 fail）。**D405** 手测仍开。不关 D8/D16/D147。未升 PRD-008。 |
