...
phase: N/A
updated: 2026-09-01
summary: "跨层 Chat：contrib 模型/UI、宿主清单、Copilot 边界、sessions 窗口消费、页面接入；PRD-015–016 accepted 未实施"
---
...
- session 窗口 / chat tab：[conversation-session-windows](../../../dev/plans/conversation-session-windows.md)（accepted · PRD-016 · [ADR-002](../../../dev/decisions/002-conversation-session-windows.md) · 未实施）
