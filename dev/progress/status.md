...
phase: M7
updated: 2026-09-12
summary: "已合入 D364–D365（未编译）。D8/D16/D147 仍开。"
---
...
### 关仓（2026-09-12 · A D364 / B D365 已合入；未 compile-client）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | `agents-instructions leftover-looks-live` [D364](deferred-gaps.md) | 已合入 `5915f7d2aec`；Instructions 0 extra `saveAgentProfile` |
| **B** | `snapshots-post-await leftover-looks-live` [D365](deferred-gaps.md) | 已合入 `3652a575281`；in-flight leftover-looks-live 不画 live |
...
| A | `vscode-WorkTrees/A` | `loop/A` | `5915f7d2aec` | 干净 | 0 | 已收 D364 |
| B | `vscode-WorkTrees/B` | `loop/B` | `3652a575281` | 干净 | 0 | 已收 D365 |
...
| **loop 切片** | [D364](deferred-gaps.md)–[D365](deferred-gaps.md) 已合入（未编译）。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto；未宣称 leftover-honesty 程序完成 |
