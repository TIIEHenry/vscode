...
| [008-write-git-apply-hunks-empty.md](008-write-git-apply-hunks-empty.md) | `accepted` | R8 已闭：引擎空 `patches` = 成功空操作；产品选项 A 宿主拒空 Accept（[sources-accept-empty-success](../plans/sources-accept-empty-success.md) `draft`，P5 停线；A2 须**新**方案 + **新** Arch-First，不是给该 draft 盖章）；D31 F4 未跑 |
