...
phase: M7
updated: 2026-09-12
summary: "关仓 MERGE_SHA 3c07195f6bf 已 push origin/agent-ide；compile-client 0；D405 手测仍开；D406/D407/D409 已闭；D408 仍开；下号 D410；未升 PRD-008"
---
...
| [D405](deferred-gaps.md)–[D409](deferred-gaps.md) | A/B/D 本波 | D405 **仍开**（§5 手测未跑；合入后 compile-client 类型已修为 0）；D406 **closed** KEEP leftover；D407 **closed** probeEngine；D408 连接级重连仍开；D409 **closed** acquire-throw 通知 |
...
| A | `vscode-WorkTrees/A` | `loop/A` | `3c07195f6bf` | 干净 | 0 | `idle`；已 cascade |
...
| **loop 切片** | **MERGE_SHA `3c07195f6bf`** 已 push。**D405 仍开**（§5 手测）。**D406/D407/D409** 已闭。**D408** 连接级重连仍开。不关 D10/D16/D18/D20/D12。下号 **D410**。未升 PRD-008。 |
