...
created: 2026-08-30
updated: 2026-09-08
summary: "延期缺口 SSOT；D16 仍开；D45–D67 已闭；D22 F3；D24 其余 JSON RPC；D25 引擎 List 真空；D26 引擎建壳回 6；D31 F4 / A2 blocked；Team leftover 已清；Connection listDevices/listPending throw 保留末次快照；renameDevice / 成功后 refreshDirectory throw 画 banner；login / changePassword throw 画 hubAuthBadge；probeConnectionProfile / logout / Hub fallback revokeDevice / confirmDeviceCode throw 画对应 hook；Snapshots / MCP Add·Update·Remove·toggle / Skills create·toggle·save / Agents / Tools enablement 写失败 write-status 已挂载；Agents Tools 页 listTools throw 画 failed；MCP runtime getMcpServerTools throw 清 leftover 并画 failed"
---
