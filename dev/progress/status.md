...
phase: M7
updated: 2026-09-16
summary: "工位 I leftover：D574 关 setSection×3 + showEmbeddedEditor×1。compile-client 0。D24 仍开。不是 leftover/pills 完成。"
---
...
| **I** | leftover setSection/showEmbeddedEditor 双链；[D574](deferred-gaps.md)；未 commit |
...
| [D574](deferred-gaps.md) | **closed** 本文件四处 call site；leftover **未**全局完成 |
