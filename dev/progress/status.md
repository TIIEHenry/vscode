...
phase: M7
updated: 2026-09-17
summary: "A 槽 D608 chatCompositeBar CLOSE 双链；mocha 2/0。D24 仍开。不是 leftover/pills 完成。未 commit。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **A** | `loop/A-d24-chatbar-close-leftover` CLOSE 双链；[D608](deferred-gaps.md)；mocha **2/0**；未 commit；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D608](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
