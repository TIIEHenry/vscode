...
| [002-conversation-session-windows.md](002-conversation-session-windows.md) | `proposed` | 默认窗 Conversation 作用域 EditorPart；Fork 默认 tab；子代理对话框/最大化才 tab；不推翻 ADR-001 |
