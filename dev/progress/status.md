...
| 槽 | 状态 |
|:---|:-----|
| **G** | `loop/G-d24-mode-sync-leftover` `_applyMode` 双链；[D652](deferred-gaps.md)；D24 仍开；不是 leftover 完成；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D647](deferred-gaps.md)/[D652](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
