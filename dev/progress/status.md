...
| 槽 | 状态 |
|:---|:-----|
| **D** | onDidClick `_select` 双链；[D634](deferred-gaps.md)；未 commit。勿 add `out`。D24 仍开 |
...
| [D550](deferred-gaps.md)–[D634](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
