...
phase: M7
updated: 2026-09-17
summary: "I leftover D614 overview loadCounts 五处双链。未 commit。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **I** | [D614](deferred-gaps.md) `loadCounts` 五处双链；mocha 源扫；未 commit；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D607](deferred-gaps.md)/[D614](deferred-gaps.md) | leftover catch 关各 call site；leftover **未**全局完成 |
