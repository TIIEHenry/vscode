...
phase: M7
updated: 2026-09-14
summary: "MERGE_SHA=`ef39b942f74`；本关仓合并 D454 SessionBar leftover handlers + D455 Navigator leftover Refresh/switch；D405 仍开；不得宣称 leftover wave 完成"
---
...
### 进行中（2026-09-14 · 本关仓合并 D454+D455）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | D454 SessionBar leftover handlers | 两边保留合入；勿宣称 leftover wave 完成 |
| **B** | — | 脏 `worktree-pool.md` 勿 add / 勿 `-B` |
| **C** | — | 脏 `dev/loop`；勿 add / 勿 `-B` |
| **D** | D455 Navigator leftover Refresh/switch | 两边保留合入；勿宣称 leftover wave 完成 |
...
| [D405](deferred-gaps.md)–[D455](deferred-gaps.md) | A/D 本波 | D405 手测仍开；D454 SessionBar leftover handlers + D455 Navigator leftover Refresh/switch 两边保留合入；不得宣称 leftover wave 完成 |
...
| A | `vscode-WorkTrees/A` | `loop/A` | `8e6a28846e1` | D454 | 0 | D454 SessionBar leftover handlers 已闭未合 |
...
| **loop 切片** | `MERGE_SHA`=`ef39b942f74`。本关仓合并 **D454** SessionBar leftover handlers + **D455** Navigator leftover Refresh/switch。**D405** 手测仍开。不关 D8/D16/D147。未升 PRD-008。不得宣称 leftover wave 完成。 |
