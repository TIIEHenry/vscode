...
phase: M7
updated: 2026-09-17
summary: "F leftover：picker item.run/commandId 双链；[D611]。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **F** | leftover `sessionWorkspacePicker` item.run/commandId 双链；[D611](deferred-gaps.md)；mocha **2/0**；未 commit；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D607](deferred-gaps.md)/[D611](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
