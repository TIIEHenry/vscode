...
phase: M7
updated: 2026-09-12
summary: "已关仓 D364–D366 compile-client 0。已收 D369（未提交）。D8/D16/D147 仍开。"
---
...
### 关仓（2026-09-12 · A D364 / B D365 / D D366 compile-client 0）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | `agents-instructions leftover-looks-live` [D364](deferred-gaps.md) | 已关仓 `5915f7d2aec`；Instructions 0 extra `saveAgentProfile` |
| **B** | `snapshots-post-await leftover-looks-live` [D365](deferred-gaps.md) | 已关仓 `3652a575281`；in-flight leftover-looks-live 不画 live |
| **D** | `history-post-await leftover-looks-live` [D366](deferred-gaps.md) | 已关仓 `661e5ba9f3c`；in-flight getHistory 再检 KEEP |
| **D** | `navigator-team-post-await leftover-looks-live` [D369](deferred-gaps.md) | 已收 D369（未提交）；in-flight leftover-looks-live KEEP leftover + stale-note |
...
| A | `vscode-WorkTrees/A` | `loop/A` | 跟 MERGE_SHA | 干净 | 0 | idle；已收 D364 |
| B | `vscode-WorkTrees/B` | `loop/B` | 跟 MERGE_SHA | 干净 | 0 | idle；已收 D365 |
| C | `vscode-WorkTrees/C` | `loop/C` | 跟 MERGE_SHA | 未提交 `dev/loop` | 0 | idle；勿 add `dev/loop` |
| D | `vscode-WorkTrees/D` | `loop/D` | 跟 MERGE_SHA | 脏 | 0 | 已收 D369（未提交） |
...
| **loop 切片** | [D364](deferred-gaps.md)–[D366](deferred-gaps.md) 已关仓。已收 [D369](deferred-gaps.md)（未提交）。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto；未宣称 leftover-honesty 程序完成 |
