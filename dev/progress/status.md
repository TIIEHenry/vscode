...
phase: M7
updated: 2026-09-14
summary: "MERGE_SHA=`d33f608ebb0`；工位 A D456 Fork/Kill leftover handlers；D457 由 D 占用；D405 仍开；不得宣称 leftover wave 完成"
---
...
### 进行中（2026-09-14 · 工位 A D456；D457 由 D 占用）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | D456 Fork/Kill leftover handlers | 本工位；KEEP leftover `tryConnectedEngineFork`/`tryKillSubAgent`；不占 D457 |
| **B** | — | 脏 `worktree-pool.md` 勿 add / 勿 `-B` |
| **C** | — | 脏 `dev/loop`；勿 add / 勿 `-B` |
| **D** | D457 Navigator leftover Inspect/Reveal + Refresh context key | 由 D 占用；本工位不写 D457 开闭细节 |
...
| [D405](deferred-gaps.md)–[D456](deferred-gaps.md) | A/D 本波 | D405 手测仍开；D454/D455 已合；A 本工位 D456；D457 由 D 占用；不得宣称 leftover wave 完成 |
...
| D | `vscode-WorkTrees/D` | `loop/D` | `d33f608ebb0` | 干净 | 0 | D457 由 D 占用（Navigator leftover Inspect/Reveal + Refresh context key） |
...
| **loop 切片** | `MERGE_SHA`=`d33f608ebb0`。工位 A **D456** Fork/Kill leftover handlers（未合）。**D457** 由 D 占用。**D405** 手测仍开。不关 D8/D16/D147。未升 PRD-008。不得宣称 leftover wave 完成。 |
