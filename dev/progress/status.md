...
phase: M7
updated: 2026-09-12
summary: "D315–D323 已关仓。D8/D16/D147 仍开。"
---
...
### 关仓（2026-09-12 · A D322 + B D323；前波 D315–D321 已在库）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | `diff-review-stage-git-stage-fallthrough` [D322](deferred-gaps.md) | `already-committed` `3b08ec05c13`；Stage 不再 fallthrough `git.stage` |
| **B** | `hub-rename-leftover-looks-live` [D323](deferred-gaps.md) | `already-committed` `644b2326787`；Hub Rename leftover 写闸 |
...
| **loop 切片** | [D315](deferred-gaps.md)–[D323](deferred-gaps.md) 已关仓。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto |
