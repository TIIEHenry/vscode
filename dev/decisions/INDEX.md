...
phase: N/A
updated: 2026-09-01
summary: "本仓库本地 ADR 索引；上游 wiki 决策不迁入；ADR-002 默认窗 Conversation 窗口/tab 拟议"
---
...
| [002-conversation-session-windows.md](002-conversation-session-windows.md) | `proposed` | 每 session 叶一个 Conversation IEditorPart；围栏 CONVERSATION_GROUP；不推翻 ADR-001 |
