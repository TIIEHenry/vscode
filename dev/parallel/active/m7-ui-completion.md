...
phase: M7
updated: 2026-09-02
summary: "P 槽（platform/universeAgent 合同，含 Web 断连三服务）+ A=Engine/Connection、B=Conversation→Client Settings、C=品牌/键位/主题/Web 冒烟 + 非阻塞验证槽的文件所有权、切片顺序与依赖"
---
