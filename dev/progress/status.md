...
phase: M7
updated: 2026-09-16
summary: "D 槽 D475 两处 disconnect catch（不重开 D186）。D24 仍开。不是 leftover/pills 完成。R9/D405 仍开"
---
...
### 进行中（2026-09-16 · 未 compile-client；D475 catch；D24 仍开；不是 leftover/pills 完成）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A/D** | 六 unary + D475 | A：六 roster unary bytes、[D24](deferred-gaps.md) **仍开**（listTools JSON）；D：两处 `_disconnectEnvironment` catch、[D475](deferred-gaps.md) **closed**（不重开 D186）。未 compile-client。不是 leftover/pills 完成 |
...
| [D24](deferred-gaps.md) | A 槽 `d24-next-known-unaries-3` | **仍开**：CancelSessionGoal/Respond/Fork/Kill/DeleteMessage/EditMessage 已 bytes；`listTools` 仍 JSON；其余活 JSON 未转 |
...
| [D405](deferred-gaps.md)–[D475](deferred-gaps.md) | A/D 本波 | D405 手测仍开；D471–D475 已闭；**D24 仍开**（listTools JSON）；不得宣称 leftover/pills 完成 |
...
| **loop 切片** | 未 compile-client。D 槽两处 disconnect catch。[D475](deferred-gaps.md) **closed**（不重开 D186）。[D24](deferred-gaps.md) **仍开**（`listTools` JSON）。R9 仍开。**D405** 手测仍开。不关 D8/D16/D147。未升 PRD-008。不得宣称 leftover / pills 完成。 |
