...
phase: M7
updated: 2026-09-12
summary: "已收 D341（未提交）。D8/D16/D147 仍开。"
---
...
| **D** | `connection-hub-leftover-looks-live` [D341](deferred-gaps.md) | 未提交；Hub device/pending leftover 写闸 |
...
| D | `vscode-WorkTrees/D` | `loop/D` | 跟 MERGE_SHA | 脏 | 0 | 已收 D341（未提交） |
...
| **loop 切片** | [D341](deferred-gaps.md) 已收（未提交）。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto |
