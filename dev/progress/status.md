...
phase: M7
updated: 2026-09-12
summary: "已合入 D361–D363（未编译）。D8/D16/D147 仍开。"
---
...
### 关仓（2026-09-12 · A D361 / B D362 / D D363 已合入；未 compile-client）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
...
| **D** | `navigator-projects-waseverconnected` [D363](deferred-gaps.md) | 已合入 `1f5e3268827`；leftover-looks-live 事件不翻 wasEverConnected |
...
| D | `vscode-WorkTrees/D` | `loop/D` | `1f5e3268827` | 干净 | 0 | 已收 D363 |
...
| **loop 切片** | [D361](deferred-gaps.md)–[D363](deferred-gaps.md) 已合入（未编译）。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto；未宣称 leftover-honesty 程序完成 |
