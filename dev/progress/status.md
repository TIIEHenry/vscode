...
| 槽 | 状态 |
|:---|:-----|
| **D leftover** | `browserAutoReloadFeatures` `reload` 双链；[D658](deferred-gaps.md)；未 commit；勿 add `out`。D24 **仍开**。不是 leftover/pills 完成 |
...
| [D550](deferred-gaps.md)–[D655](deferred-gaps.md)、[D658](deferred-gaps.md) | **closed** leftover catch 各 call site；leftover **未**全局完成 |
