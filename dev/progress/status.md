...
phase: M7
updated: 2026-09-16
summary: "I 本刀 Agent.Branch wire 已落未接线（branch_index 0/-1 必写）。D24 仍开。不是 leftover/pills 完成。"
---
...
| **I** | `d24-branch-unary-wire`：Branch wire 已写未接线；勿改 grpcClient；D24 仍开 |
| **edit** | ff-only 失败（分歧 `ff278772b85`）；勿 reset |

子 agent 发现：
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：Clear/Get·SetModelPreferences **已** bytes；SwitchWorkDir/Compact/Todo/Usage/Status/Branch wire 未接线；ResolveTurn/Connect/SaveSkillContent/Watch·Rebuild 仍 JSON |
...
| 项 | 指针 |
|:---|:-----|
| **loop** | D24 仍开。I 本刀 Branch wire 已落未接线。A 下一刀接 SwitchWorkDir/Compact/Todo/Usage/Status/Branch。SaveSkillContent 无 RPC。Connect/Watch 跳过。不得宣称 leftover/pills 完成 |
