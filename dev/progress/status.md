...
phase: M7
updated: 2026-09-10
summary: "GitHub Actions 永久关闭（见 workflows/DISABLED.md）。loop 关仓：D267–D269 已合入；merge compile-client 0。"
---
...
| 槽 | 切片 | 状态 |
|:---|:-----|:-----|
| **A** | tools-info-selection-leftover | 本槽；failed/loading 保 leftover 详情；[D270](deferred-gaps.md) 已闭 |
...
| [D242](deferred-gaps.md)–[D269](deferred-gaps.md) | A–D leftover 关仓波 | **closed** catalog 子面板 + roster/timeline in-flight + Snapshots no-hook + Agents tools UNKNOWN；merge compile-client 0 |
...
| **loop 切片** | D267–D269 已 compile-client 0。下一波 Tools 详情 / Agents tools 面板 failed 下被藏（D270/D271）。勿派 D147 / 勿开 F3·A2 / 勿发明 proto |
