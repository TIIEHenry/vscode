...
phase: M7
updated: 2026-09-16
summary: "merge compile-client 0；聚焦 206 passing / 0 pending。D24 仍开。D488–D492 closed；H D495 closed 未提交；D487 open。不是 leftover/pills 完成。R9/D405 仍开"
---
...
### 进行中（2026-09-16 · H D495 closed 未提交；D24 仍开；不是 leftover/pills 完成）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
...
| **H** | D495 conversation nav void catch | **closed** 未提交；五处 D480 双链；测已扩 warn-then-rethrow；条数合入时复跑。未关 D24。不重开 D174/D180/D182/D186。不得 leftover/pills 完成 |
...
| [D495](deferred-gaps.md) | H | **closed** 未提交：五处 conversation nav void 双链 catch；测已扩 warn-then-rethrow；条数合入时复跑。未关 D24。不重开 D174/D180/D182/D186 |
...
| H | `vscode-WorkTrees/H` | `loop/H` | MERGE_SHA | 脏未提交 | 0 | D495 closed 未提交 |
...
| **loop 切片** | [D24](deferred-gaps.md) **仍开**。[D488](deferred-gaps.md)–[D492](deferred-gaps.md) **closed**。[D495](deferred-gaps.md) **closed** 未提交。[D487](deferred-gaps.md) **open**。R9 / **D405** 仍开。不关 D8/D16/D147。不得宣称 leftover / pills 完成 |
