...
phase: M7
updated: 2026-09-14
summary: "MERGE_SHA=`a653fc086aa` 已 push；compile-client 0；D444 Sources FileDiff leftover + D445 Navigator leftover chrome 已合；D405 仍开；下号 D446"
---
...
### 进行中（2026-09-14 · D444/D445 已合入并 push）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | D444 Sources leftover FileDiff 关读门 | 已合入 `a653fc086aa`；跟 MERGE_SHA |
...
| [D405](deferred-gaps.md)–[D445](deferred-gaps.md) | A/B/D 本波 | D405 手测仍开；D444/D445 已合 `a653fc086aa`（FileDiff leftover + Navigator leftover chrome）；不得宣称 leftover wave 完成 |
...
| **loop 切片** | `MERGE_SHA`=`a653fc086aa`。**D444**–**D445** 已合（FileDiff leftover + Navigator leftover chrome）。下号 **D446**。**D405** 手测仍开。不关 D8/D16/D147。未升 PRD-008。不得宣称 leftover wave 完成。 |
