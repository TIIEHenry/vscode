...
/** AgentService.CreateSnapshot — persist a session checkpoint (≠ ListSnapshots / SessionBar History / Delete). */
...
/** AgentService.RestoreSnapshot — restore a session checkpoint (≠ ListSnapshots / SessionBar History / Delete). */
