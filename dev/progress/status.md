...
phase: M7
updated: 2026-09-17
summary: "F leftover：promptFileContributions ctor updateRegistration 双链；D579 关本 call site。未 commit。未 compile-client。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **F leftover** | `promptFileContributions.ts` ctor `void this.updateRegistration()` 双链；[D579](deferred-gaps.md)；mocha 源扫 **2/0**。未 commit。不是 leftover/pills 完成。D24 仍开。 |
...
| [D550](deferred-gaps.md)–[D575](deferred-gaps.md)、[D579](deferred-gaps.md) | **closed** leftover catch（各 call site）；leftover **未**全局完成 |
