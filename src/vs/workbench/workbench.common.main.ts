...
import './browser/parts/conversation/conversationPart.js';
import './browser/parts/sources/sourcesPart.js';
...
// Sources (End column Files list projection)
import './contrib/sources/browser/sources.contribution.js';
