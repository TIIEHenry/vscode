...
| 槽 | 状态 |
|:---|:-----|
| **I** | D654 `_openSource?.()` 双链；mocha 2/0；未 commit；compile-client 0；D24 仍开；不是 leftover/pills 完成 |
...
| [D550](deferred-gaps.md)–[D647](deferred-gaps.md)、[D654](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
