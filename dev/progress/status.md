...
| **C** | provider-model-unknown-leftover | [D252](deferred-gaps.md) 已闭；勿 add `dev/loop` |
...
| [D242](deferred-gaps.md)–[D249](deferred-gaps.md) | A–D leftover 关仓波 | **closed** Snapshots / hooks / Changes / Review / History / Agents tools / Hub directory / Composer preclear leftover；merge compile-client 0 |
...
| **loop 切片** | D246–D249 已 compile-client 0；下一波从代码搜 leftover（D250+）。勿派 D147 / 勿开 F3·A2 / 勿发明 proto / 勿改引擎仓 |
