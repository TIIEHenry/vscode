...
phase: M7
updated: 2026-09-16
summary: "H 已写 ResolveModel wire（ModelEntry unread）未接线。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **H** | ResolveModel wire（ModelEntry unread）未接线；勿 add `out`；未关 D24 |
...
| ID | 问题 |
|:---|:-----|
| [D24](deferred-gaps.md) | **仍开**：七条 **已** bytes；GetConfig/DeleteConfig/Reload/Destroy·Cancel·Resume/CheckConnection/ResolveModel wire 未接线；Connect/SaveSkillContent/Watch 仍 JSON |
