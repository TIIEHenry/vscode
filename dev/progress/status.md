...
phase: M7
updated: 2026-09-13
summary: "MERGE_SHA=`431623deb7b` 已 push；compile-client 0；D415/D416 已合；D417/D418/D419/D405 仍开；下号 D420"
---
...
| **loop 切片** | `MERGE_SHA`=`431623deb7b`（D415/D416；已 push `loop/merge`/`agent-ide`）。compile-client 0。**D405** 手测仍开。**D417/D418/D419** 仍开。不关 D8/D16/D147。下号 **D420**。未升 PRD-008。 |
