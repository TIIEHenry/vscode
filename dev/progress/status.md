...
phase: M7
updated: 2026-09-12
summary: "D326–D328 已合入。D8/D16/D147 仍开。"
---
...
### 关仓（2026-09-12 · A D326 + B D327 + D D328；compile-client 0）
| 槽 | 切片 | 状态 |
|:---|:-----|:---------|
| **A** | `roster-cancel-goal-leftover-looks-live` [D326](deferred-gaps.md) | `already-committed` `3bf519dec67`；roster cancel/goal leftover 写闸 |
...
| A | `vscode-WorkTrees/A` | `loop/A` | 已收 D326 | 干净 | 0 | 已收 D326 |
...
| **loop 切片** | [D326](deferred-gaps.md)–[D328](deferred-gaps.md) 已关仓；compile-client 0。勿派 D8/D147 / 勿开 F3·A2 / 勿发明 proto |
