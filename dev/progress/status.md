...
phase: M7
updated: 2026-09-10
summary: "loop 关仓：本波 A–D 已合入 merge。D222–D225 已闭。B 槽 D227 MCP Runtime leftover 已收。compile-client 0。"
---
...
| **B** | mcp-runtime-list-leftover | [D227](deferred-gaps.md) 已收；成功→`getMcpServerStatuses` throw 保 leftover 行 + failed；首拉 throw 仍 empty+failed；未 compile-client |
