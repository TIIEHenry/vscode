...
phase: M7
updated: 2026-09-16
summary: "merge 关仓：leftover D560–D567 关各 call site。H leftover D573 关 voiceModeOnboarding executeCommand/persist 本 call site。compile-client 0。D24 仍开。不是 leftover/pills 完成。"
---
...
| **H leftover** | executeCommand / persist 双链；[D573](deferred-gaps.md) 关本 call site；D24 仍开 |
...
| [D550](deferred-gaps.md)–[D567](deferred-gaps.md)、[D573](deferred-gaps.md) | **closed** leftover catch（D573 仅 executeCommand/persist）；leftover **未**全局完成 |
