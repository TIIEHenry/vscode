...
phase: M7
updated: 2026-09-04
summary: "接通后时间线权限座转发 PermissionService.Respond（不双写 Chat 臂）；Cancel Tool / Fork / Goal / Create / Rename / Cancel 已转发；Engine Tools 选中行读 ToolInfo 只读详情；Kill catalog 已进、roster 未转发；队列 UI 仍 fixture"
---
...
| B | `vscode-WorkTrees/B` | `loop/B` | 接通后权限座转发 PermissionService.Respond |
