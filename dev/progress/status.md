...
phase: M7
updated: 2026-09-17
summary: "A 进行中：D24 SubscribeToolDetail wire+测。grpcClient 仍 JSON。D24 仍开。不是 leftover/pills 完成。"
---
...
| 槽 | 状态 |
|:---|:-----|
| **A** | `d24-subscribe-tool-detail-wire`：SubscribeToolDetail wire+测；grpcClient 仍 JSON；[D24](deferred-gaps.md) 仍开 |
...
| 项 | 指针 |
|:---|:-----|
| **loop** | D24 仍开。SubscribeToolDetail wire 已落、grpcClient 未接线。SaveSkillContent 无 RPC。Connect/Watch/ResolveAnchor/ResolveTurn 跳过。不得宣称 leftover/pills 完成 |
