...
phase: M7
updated: 2026-09-08
summary: "FileMutationJoin / createScoped / Review 委托已修。D16 仍开。官方三域 glob 已绿。D44–D49 已闭。git-read / open-diff / Stage·Commit throw status DOM 已挂载。A2 仍 blocked。"
---
...
|----|------|------|-----|:--|:------|:---------|
| merge | `vscode-WorkTrees/merge` | `loop/merge` | `0ef34db7ea1` | `__pycache__` | 0 | parked；compile 基线 unused 仍红，**不 push** |
| A | `vscode-WorkTrees/A` | `loop/A` | `0ef34db7ea1` | `__pycache__` | 0 | idle |
| B | `vscode-WorkTrees/B` | `loop/B` | `0ef34db7ea1` | `__pycache__` | 0 | idle |
| C | `vscode-WorkTrees/C` | `loop/C` | `0ef34db7ea1` | 未提交 `dev/loop` + `__pycache__` | 0 | idle；勿 add `dev/loop` |
| D | `vscode-WorkTrees/D` | `loop/D` | `0ef34db7ea1` | `__pycache__` | 0 | idle |
| edit | `Projects/Agents/vscode` | `agent-ide` | `a40a95d1e85`+ | `dev/loop` + 过期 progress | 0 | 人类工位；请自行对齐 `0ef34db7ea1` |
