...
| **I** | `loop/I-d24-sessions-view-open-leftover` — sessionsView 四处 open then 双链；[D630](deferred-gaps.md)；D24 仍开；leftover 未全局完成；勿 add `out` |
...
| [D550](deferred-gaps.md)–[D623](deferred-gaps.md)/[D630](deferred-gaps.md) | **closed** leftover catch；leftover **未**全局完成 |
